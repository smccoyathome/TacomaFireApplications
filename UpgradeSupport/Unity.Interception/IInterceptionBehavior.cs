...
namespace Microsoft.Practices.Unity.InterceptionExtension
{
    ...
    public interface IInterceptionBehavior
    {
        ...
        VirtualMethodInvocation Invoke(VirtualMethodInvocation input, GetNextInterceptionBehaviorDelegate getNext);
    ...
    public delegate VirtualMethodInvocation InvokeInterceptionBehaviorDelegate(VirtualMethodInvocation input, GetNextInterceptionBehaviorDelegate getNext);
