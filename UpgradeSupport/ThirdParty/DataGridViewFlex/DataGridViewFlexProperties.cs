...
using UpgradeHelpers.Properties;
using System;
...
namespace UpgradeHelpers
{
    ...
    public partial class DataGridViewFlex
    {
        ...
        /// </summary>
        [Obsolete("For a DataGridViewFlex you have to use the ColumnsCount property instead")]
        ...
        public int CurrentColumnIndex
        {
            get
            {
                if (GeneralCurrentCell != null)
                    return RowHeadersVisible ? GeneralCurrentCell.ColumnIndex + 1 : GeneralCurrentCell.ColumnIndex;
                else if (CurrentCell != null)
                {
                    return RowHeadersVisible ? CurrentCell.ColumnIndex + 1 :
        ...
        public int CurrentRowIndex
        {
            ...
            {
                if (GeneralCurrentCell != null)
                    return ColumnHeadersVisible ? GeneralCurrentCell.RowIndex + 1 : GeneralCurrentCell.RowIndex;
                else if (CurrentCell != null)
                {
                    return ColumnHeadersVisible ? CurrentCell.RowIndex + 1 : CurrentCell.RowIndex;
                }
                else
                    return -1;
            }
        ...
        public int FixedRows
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (value >= _rows)
                    {
                        // Different behavior than the original, but used to prevent issues with the order of the property setting in the designer file
                        RowsCount = value + 1;
                    }
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (value >= _cols && DesignMode)
                        throw new ArgumentException(Resources.FixedColumnLessThanColumnsCount);
                    if (_FixedColumns == value || (value == 0 && Columns.Count > 0)) //The value is the same just exit
                    {
                        return;
                    }
                    #endregion
