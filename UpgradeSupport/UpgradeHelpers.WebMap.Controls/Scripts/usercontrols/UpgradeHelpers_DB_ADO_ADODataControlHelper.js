...
define("usercontrols/UpgradeHelpers_DB_ADO_ADODataControlHelper", [], function () {
    var ui = kendo.ui;
    /**
     ...
     */
    var UpgradeHelpers_DB_ADO_ADODataControlHelper = (function () {
        function UpgradeHelpers_DB_ADO_ADODataControlHelper() {
            this.options = {
         ...
         */
        UpgradeHelpers_DB_ADO_ADODataControlHelper.prototype.initClientMethods = function (value) {
            var that = value;
            value.logic = {};
            value.logic.b_first_Click = function (e) {
                return window.app.sendAction({ mainobj: that, controller: "ADODataControlHelper", action: "b_first_Click" });
            };
            value.logic.b_prev_Click = function (e) {
                return window.app.sendAction({ mainobj: that, controller: "ADODataControlHelper", action: "b_prev_Click" });
            };
            value.logic.b_next_Click = function (e) {
                return window.app.sendAction({ mainobj: that, controller: "ADODataControlHelper", action: "b_next_Click" });
            };
            value.logic.b_last_Click = function (e) {
                return window.app.sendAction({ mainobj: that, controller: "ADODataControlHelper", action: "b_last_Click" });
            };
        };
        return UpgradeHelpers_DB_ADO_ADODataControlHelper;
    }());
    var ancestor = ui.BaseUserControl;
    ui.plugin(ui.BaseUserControl.extend(new UpgradeHelpers_DB_ADO_ADODataControlHelper()));
});
//# sourceMappingURL=UpgradeHelpers_DB_ADO_ADODataControlHelper.js.map