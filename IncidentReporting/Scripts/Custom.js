...
(function (Mobilize) {
    ...
    (function (WebMap) {
        var Kendo;
        (function (Kendo) {
            Mobilize.WebMap.Kendo.DragAndDropRegister.prototype.dragHandler =
                function (command) {
                    var controlSelector = "#" + command.form + " #" + command.ControlName;
                    var ele = $(controlSelector);
                    ...
                    var event = window.app.mouseDragEvent;
    ...
    })(WebMap = Mobilize.WebMap || (Mobilize.WebMap = {}));
})(Mobilize || (Mobilize = {}));
