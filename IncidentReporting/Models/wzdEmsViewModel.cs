...
namespace TFDIncident.ViewModels
{
		...
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		public override void Build(UpgradeHelpers.Interfaces.IIocContainer ctx)
		{
			...
			this.txtRespiration[1].Enabled = true;
			...
			this.txtRespiration[2].Enabled = true;
			...
			this.txtRespiration[3].Enabled = true;
			...
			this.txtSystolic[1].Enabled = true;
			...
			this.txtSystolic[2].Enabled = true;
			...
			this.txtSystolic[3].Enabled = true;
			...
			this.txtDiastolic[1].Enabled = true;
			...
			this.txtDiastolic[2].Enabled = true;
			...
			this.txtDiastolic[3].Enabled = true;
