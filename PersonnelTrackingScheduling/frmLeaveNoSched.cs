...
namespace PTSProject
{
	...
	public partial class frmLeaveNoSched
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmLeaveNoSchedViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmLeaveNoSched));
		...
		private void frmLeaveNoSched_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		private void FormatReport()
		{
			...
			string sStringText = "spReport_LeaveWithoutScheduleList ";
		...
		{
			//    MsgBox "This feature is coming soon!", vbOKOnly, "Leave Without Schedule Report"
			...
			ViewModel.sprReport.setPrintAbortMsg("Printing PTS Leave Without Schedule Report");
		...
		public static frmLeaveNoSched DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmLeaveNoSched CreateInstance()
		{
			PTSProject.frmLeaveNoSched theInstance = Shared.Container.Resolve< frmLeaveNoSched>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmLeaveNoSchedViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmLeaveNoSched m_vb6FormDefInstance { get; set; }
