...
namespace PTSProject
{
	...
	public partial class frmPMRoverPayroll
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmPMRoverPayrollViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmPMRoverPayroll));
		...
		private void frmPMRoverPayroll_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void RefreshEmployeeList()
		{
			...
			oCmd.Connection = modGlobal.oConn;
			oCmd.CommandType = CommandType.Text;
			sStringText = "spSelect_PMRoverEmployeeGridList ";
							...
							else
							{
								...
								if ( sOTHours == 0 )
								{
									...
									else
									{
										...
										ViewManager.ShowMessage("Insert Failed!!", "Insert Personnel Payroll for " + ((DateTime.TryParse(PayrollDate, out
											TempDate103)) ? TempDate103.ToString("MM/dd/yyyy") : PayrollDate), UpgradeHelpers.Helpers.BoxButtons.OK, UpgradeHelpers.Helpers.BoxIcons.Error);
									}
								}
								else if ( sOTHours >= Double.Parse(ViewModel.txtSu1.Text) )
								{
									...
									else
									{
										...
										ViewManager.ShowMessage("Insert Failed!!", "Insert Personnel Payroll for " + ((DateTime.TryParse(PayrollDate, out
											TempDate104)) ? TempDate104.ToString("MM/dd/yyyy") : PayrollDate), UpgradeHelpers.Helpers.BoxButtons.OK, UpgradeHelpers.Helpers.BoxIcons.Error);
									}
								}
								else
								{
									...
									else
									{
										...
										ViewManager.ShowMessage("Insert Failed!!", "Insert Personnel Payroll for " + ((DateTime.TryParse(PayrollDate, out
											TempDate105)) ? TempDate105.ToString("MM/dd/yyyy") : PayrollDate), UpgradeHelpers.Helpers.BoxButtons.OK, UpgradeHelpers.Helpers.BoxIcons.Error);
									}
									PayrollCL.PPhours = Double.Parse(ViewModel.txtSu1.Text) - sOTHours;
									PayrollCL.PPsap_acttype = "";
									PayrollCL.PPsap_rec_center = "";
									...
									else
									{
										...
										ViewManager.ShowMessage("Insert Failed!!", "Insert Personnel Payroll for " + ((DateTime.TryParse(PayrollDate, out
											TempDate106)) ? TempDate106.ToString("MM/dd/yyyy") : PayrollDate), UpgradeHelpers.Helpers.BoxButtons.OK, UpgradeHelpers.Helpers.BoxIcons.Error);
									}
								}
							}
						}
		...
		public static frmPMRoverPayroll DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null )
		...
		public static frmPMRoverPayroll CreateInstance()
		{
			PTSProject.frmPMRoverPayroll theInstance = Shared.Container.Resolve<frmPMRoverPayroll>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmPMRoverPayrollViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmPMRoverPayroll m_vb6FormDefInstance { get; set; }
