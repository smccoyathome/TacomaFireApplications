...
namespace PTSProject
{
	...
	public partial class frmBattSched4
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmBattSched4ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmBattSched4));
				...
				{
					{
							...
							async1.Append<MoveEmployeeStruct>(() =>
								{
									...
									{
                                        return this.Return< MoveEmployeeStruct>(() => new PTSProject.frmBattSched4.MoveEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
									}
											...
											if ( !oRec.EOF )
											{
												...
												for ( int i = 1; i <= 11; i++ )
												{
													...
													if ( oRec.EOF )
													{
														...
														{
															PayUp = 0;
                                                            return this.Return< MoveEmployeeStruct>(() => new PTSProject.frmBattSched4.MoveEmployeeStruct(
                        ...
                        return this.Return< MoveEmployeeStruct>(() => new PTSProject.frmBattSched4.MoveEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
					}
				}
				catch
				{
		...
		public DeleteScheduleStruct DeleteSchedule(string Empid, string ShiftDate)
		{
                ...
                if (modGlobal.ErrorControl() == modGlobal.eFATALERROR)
						{
                    return new PTSProject.frmBattSched4.DeleteScheduleStruct()
		...
		public void FindUnitMinMax(int Unit)
		{
			...
			switch ( Unit )
			{
				...
				case 6:
					...
					ViewModel.MaxUnitPos = 25;
					break;
				case 7:
					ViewModel.MinUnitPos = 26;
					ViewModel.MaxUnitPos = 29;
					break;
				case 8:
					ViewModel.MinUnitPos = 30;
					ViewModel.MaxUnitPos = 33;
					break;
				case 9:
					ViewModel.MinUnitPos = 34;
					ViewModel.MaxUnitPos = 37;
					break;
				case 10:
					ViewModel.MinUnitPos = 38;
					ViewModel.MaxUnitPos = 41;
					break;
				case 11:
					ViewModel.MinUnitPos = 42;
					ViewModel.MaxUnitPos = 45;
					break;
				case 12:
					ViewModel.MinUnitPos = 46;
					ViewModel.MaxUnitPos = 49;
					break;
				case 13:
		...
		public int FindUnit(int Pos)
		{
			...
			else if ( Pos >= 34 && Pos <= 37 )
			{
				result = 9;
			}
			else if ( Pos >= 38 && Pos <= 41 )
			{
				result = 10;
			}
			else if ( Pos >= 42 && Pos <= 45 )
			{
				result = 11;
			}
				...
				{
					{
						...
						async1.Append<ScheduleEmployeeStruct>(() =>
							{
								using ( var async2 = this.Async() )
								{
									...
									{
                                        return this.Return< ScheduleEmployeeStruct>(() => new PTSProject.frmBattSched4.ScheduleEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
									}
									...
									if ( UpdateFlag != 0 )
									{
                                                var returningMetodValue314 = //Delete old Schedule record
                                             DeleteSchedule(Empid, ShiftDate);
												Empid = returningMetodValue314.Empid;
												ShiftDate = returningMetodValue314.ShiftDate;
												UpdateFlag = 0;
									}
												...
												if ( modGlobal.Shared.gFullShift != 0 )
												{
													...
													if ( !oRec.EOF )
													{
                                                    var returningMetodValue329 = DeleteSchedule(Empid, ShiftDate);
																Empid = returningMetodValue329.Empid;
																ShiftDate = returningMetodValue329.ShiftDate;
																oCmdInsert.ExecuteNonQuery(new object[] { ShiftDate, Empid, AssignID, TimeCode, PayUp, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
													}
													else
													{
                        ...
                        return this.Return< ScheduleEmployeeStruct>(() => new PTSProject.frmBattSched4.ScheduleEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
					}
				}
				catch
				{
     ...
     //       if (modGlobal.ErrorControl() == modGlobal.eFATALERROR)
		...
		internal void frmBattSched4_Activated(Object eventSender, System.EventArgs eventArgs)
		{
		...
		//UPGRADE_WARNING: (2065) Form event frmBattSched4.Deactivate has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
		[UpgradeHelpers.Events.Handler]
		internal void frmBattSched4_Deactivate(Object eventSender, System.EventArgs eventArgs)
		{
		//Call Global Refresh Form subroutine
		//to refresh displayed data on open forms
			...
			using ( var async1 = this.Async(true) )
			{
				...
				if ( ViewModel.lbPosam[Index].Text == "" )
				{
					...
					if ( Source.Name == "pnSelected" )
					{
						...
						async1.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPosition[Index].Text));
						async1.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(tempNormalized1 =>
							{
								var returningMetodValue535 = tempNormalized1;
				
						if ( returningMetodValue535.returnValue )
						{


							ShiftDate = returningMetodValue535.ShiftDate;
							tempRefParam = returningMetodValue535.Empid;
					...
					else
					{
						...
						if ( AMPM == "AM" )
						{
							...
							async1.Append<PTSProject.frmBattSched4.MoveEmployeeStruct>(() => MoveEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam2, ViewModel.lbPosition[Index].Text));
							async1.Append<PTSProject.frmBattSched4.MoveEmployeeStruct>(tempNormalized3 =>
								{
									var returningMetodValue554 = tempNormalized3;
						
										if ( returningMetodValue554.returnValue )
										{


											ShiftDate = returningMetodValue554.ShiftDate;
											tempRefParam2 = returningMetodValue554.Empid;
			...
			using ( var async1 = this.Async(true) )
			{
				...
				if ( ViewModel.lbPospm[Index].Text == "" )
				{
					...
					if ( Source.Name == "pnSelected" )
					{
						...
						string tempRefParam = Convert.ToString(ViewModel.pnSelected.Tag);
						async1.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPositionPM[Index].Text));
						async1.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(tempNormalized1 =>
							{
								var returningMetodValue587 = tempNormalized1;
					
						if ( returningMetodValue587.returnValue )
						{


							ShiftDate = returningMetodValue587.ShiftDate;
							tempRefParam = returningMetodValue587.Empid;
					...
					else
					{
						...
						if ( AMPM == "PM" )
						{
							...
							async1.Append<PTSProject.frmBattSched4.MoveEmployeeStruct>(tempNormalized3 =>
								{
									var returningMetodValue606 = tempNormalized3;
					
									if ( returningMetodValue606.returnValue )
										{


											ShiftDate = returningMetodValue606.ShiftDate;
											tempRefParam2 = returningMetodValue606.Empid;
									...
									async2.Append(() =>
										{
											using ( var async3 = this.Async() )
											{
                                                ...
                                                async3.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[Convert.
												...
												async3.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(tempNormalized7 =>
													{
														var returningMetodValue928 = tempNormalized7;
																												Response = (returningMetodValue928.returnValue) ? -1 : 0;
															StartDate = returningMetodValue928.ShiftDate;
															Empid = returningMetodValue928.Empid;
				...
				async1.Append(() =>
					{
                        ...
                        var returningMetodValue1093 = DeleteSchedule(Empid, ShiftDate);
										Empid = returningMetodValue1093.Empid;
										ShiftDate = returningMetodValue1093.ShiftDate;
										...
										if ( modGlobal.Shared.gFullShift != 0 )
										{
											...
											ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                            var returningMetodValue1095 = DeleteSchedule(Empid, ShiftDate);
													Empid = returningMetodValue1095.Empid;
													ShiftDate = returningMetodValue1095.ShiftDate;
													ViewModel.SelectedLabel.Text = "";
													OtherShift.Text = "";
													UpgradeHelpers.Helpers.ControlHelper.SetTag(ViewModel.SelectedLabel, "");
											...
											using ( var async3 = this.Async() )
											{
												...
												if ( modGlobal.Shared.gFullShift != 0 )
												{
													...
													async3.Append<PTSProject.modGlobal.ScheduleLeaveStruct>(tempNormalized3 =>
														{
															var returningMetodValue3 = tempNormalized3;
															...
															EndDate = returningMetodValue.LeaveDate;
														});
												}
												async3.Append(() =>
													{
														using ( var async4 = this.Async() )
														{
															...
															UnitID = FindUnit(UpgradeHelpers.Helpers.ControlArrayHelper.GetControlIndex(ViewModel.SelectedLabel)).ToString();
                                                            async4.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[Convert
															...
															async4.Append<PTSProject.frmBattSched4.ScheduleEmployeeStruct>(tempNormalized5 =>
																{
																	var returningMetodValue1224 = tempNormalized5;
																	Response = (returningMetodValue1224.returnValue) ? -1 : 0;
																	StartDate = returningMetodValue1224.ShiftDate;
																	modGlobal.Shared.gTradeEmp = returningMetodValue1224.Empid;
...
frmTransReport.DefInstance);
								...
								async2.Append(() =>
									{
											...
											ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                                        var returningMetodValue1281 = DeleteSchedule(Empid, ShiftDate);
														Empid = returningMetodValue1281.Empid;
														ShiftDate = returningMetodValue1281.ShiftDate;
														...
														if ( modGlobal.Shared.gFullShift != 0 )
														{
															...
															ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                                            var returningMetodValue1283 = DeleteSchedule(Empid, ShiftDate);
																	Empid = returningMetodValue1283.Empid;
																	ShiftDate = returningMetodValue1283.ShiftDate;
																	Source.Text = "";
																	OtherShift.Text = "";
																	UpgradeHelpers.Helpers.ControlHelper.SetTag(Source, "");
																	UpgradeHelpers.Helpers.ControlHelper.SetTag(OtherShift, "");
		...
		[UpgradeHelpers.Events.Handler]
		internal void sick_leave_usage_Click(Object eventSender, System.EventArgs eventArgs)
		{
            ViewManager.NavigateToView(
		...
		public static frmBattSched4 DefInstance
		{
			get
			{
					if ( Shared.m_vb6FormDefInstance == null )
		...
		public static frmBattSched4 CreateInstance()
		{
				PTSProject.frmBattSched4 theInstance = Shared.Container.Resolve<frmBattSched4>();
		...
		protected override void ExecuteControlsStartup()
		{
            ...
            ViewModel.frmUnit[15].LifeCycleStartup();
            ...
            ViewModel.frmUnit[16].LifeCycleStartup();
            ...
            ViewModel.frmUnit[17].LifeCycleStartup();
            ...
            ViewModel.frmUnit[14].LifeCycleStartup();
		...
		protected override void ExecuteControlsShutdown()
		{
            ...
            ViewModel.frmUnit[15].LifeCycleShutdown();
            ...
            ViewModel.frmUnit[16].LifeCycleShutdown();
            ...
            ViewModel.frmUnit[17].LifeCycleShutdown();
            ...
            ViewModel.frmUnit[14].LifeCycleShutdown();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmBattSched4ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmBattSched4 m_vb6FormDefInstance { get; set; }
