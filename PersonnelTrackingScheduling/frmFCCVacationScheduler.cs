...
namespace PTSProject
{
	...
	public partial class frmFCCVacationScheduler
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmFCCVacationSchedulerViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmFCCVacationScheduler));
		...
		public void SetCalendarShifts()
		{
			...
			frmFCCVacationScheduler.DefInstance.ViewModel.Visible = false;
			bool DateRequested = false;
			ViewModel.MINWorking = 4;
			...
			oCmd.CommandText = "spSelect_AnnualCalendarStepFCC '" + modGlobal.Shared.gCurrentYear.ToString() + "' ";
			...
			if (oRec.EOF)
			{
				frmFCCVacationScheduler.DefInstance.ViewModel.Visible = true;
				return;
			}
			...
			while(!oRec.EOF)
			{
				...
				{
					//UPGRADE_WARNING: (1068) GetVal(oRec(ScheduleTotal)) of type Variant is being forced to double. More Information: http://www.vbtonet.com/ewis/ewi1068.aspx
					if (Convert.ToDouble(modGlobal.GetVal(oRec["ScheduleTotal"])) <= ViewModel.MINWorking)
					{
						AMColor = "blue";
					}
					else
		...
		internal void calYear_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			//    gFCCSchedule = True
			//    dlgVacationRequest.Show vbModal
			//    gDetailDate = ""
		...
		internal void frmFCCVacationScheduler_Activated(Object eventSender, System.EventArgs eventArgs)
		{
		...
		//UPGRADE_WARNING: (2065) Form event frmFCCVacationScheduler.Deactivate has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
		[UpgradeHelpers.Events.Handler]
		internal void frmFCCVacationScheduler_Deactivate(Object eventSender, System.EventArgs eventArgs)
		{
			//    RefreshActiveForm
		}
		...
		private void Form_Load()
		{
			...
			modGlobal.Shared.gFCCSchedule = true;
		...
		public static frmFCCVacationScheduler DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmFCCVacationScheduler CreateInstance()
		{
			PTSProject.frmFCCVacationScheduler theInstance = Shared.Container.Resolve< frmFCCVacationScheduler>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmFCCVacationSchedulerViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmFCCVacationScheduler m_vb6FormDefInstance { get; set; }
