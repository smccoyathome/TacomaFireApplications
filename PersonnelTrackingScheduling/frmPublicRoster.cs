...
namespace PTSProject
{
	...
	public partial class frmPublicRoster
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmPublicRosterViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmPublicRoster));
		...
		private void frmPublicRoster_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void DisplayHeadings()
		{
			...
			ViewModel.sprRoster.Text = "Page " + ViewModel.PageNo.ToString();
			ViewModel.sprRoster.FontSize = 12;
			ViewModel.sprRoster.FontBold = true;
		...
		private void Form_Load()
		{
			...
			oCmd.CommandText = "spReport_RosterPublic";
			...
			while(!oRec.EOF)
			{
				...
				ViewModel.sprRoster.Col = 2;
				AddString = new System.Text.StringBuilder(modGlobal.Clean(oRec["address"]).Trim());
		...
		public static frmPublicRoster DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmPublicRoster CreateInstance()
		{
			PTSProject.frmPublicRoster theInstance = Shared.Container.Resolve< frmPublicRoster>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmPublicRosterViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmPublicRoster m_vb6FormDefInstance { get; set; }
