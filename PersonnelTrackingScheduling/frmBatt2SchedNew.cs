...
namespace PTSProject
{
    ...
    public partial class frmBatt2SchedNew
        : UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmBatt2SchedNewViewModel>, UpgradeHelpers.Interfaces.IInitializable
    {

        void UpgradeHelpers.Interfaces.IInitializable.Init()
        {
            this.CallBaseInit(typeof(frmBatt2SchedNew));
        ...
        //*****************************************
        //New Battalion 2 Scheduler Since Getting
        //Rid of Battalion 3
...
dlgSpecialAssign.DefInstance, true);
                ...
                {
                    {
                            ...
                            async1.Append<MoveEmployeeStruct>(() =>
                                {
                                    ...
                                    {
                                        return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmBatt2SchedNew.MoveEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
                                    }
                                            ...
                                            if (!oRec.EOF)
                                            {
                                                ...
                                                for (int i = 1; i <= 11; i++)
                                                {
                                                    ...
                                                    if (oRec.EOF)
                                                    {
                                                        ...
                                                        {
                                                            PayUp = 0;
                                                            return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmBatt2SchedNew.MoveEmployeeStruct(
                                                               )
                        ...
                        return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmBatt2SchedNew.MoveEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
                    }
                }
                catch
                {
        ...
        public DeleteScheduleStruct DeleteSchedule(string Empid, string ShiftDate)
        {
            ...
            catch
            {
                if (modGlobal.ErrorControl() == modGlobal.eFATALERROR)
                {
                    return new PTSProject.frmBatt2SchedNew.DeleteScheduleStruct()
                ...
                {
                    {
                        ...
                        if (!oRec.EOF)
                        {
                            ...
                            else
                            {
                                ...
                                return this.Return<ScheduleEmployeeStruct>(() => new PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
                            }
                        }
                        ...
                        return this.Return<ScheduleEmployeeStruct>(() => new PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
                    }
                }
                catch
                {
        ...
        public void GetBattSchedule()
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "sp_GetBattScheduleNew '" + ShiftDate + "','2'";
                oRec = ADORecordSetHelper.Open(oCmd, "");
        ...
        //UPGRADE_NOTE: (7001) The following declaration (cmdBatt2_Click) seems to be dead code More Information: http://www.vbtonet.com/ewis/ewi7001.aspx
        //private void cmdBatt2_Click()
        //{
        //
        //frmNewBattSched2.DefInstance.Show();
        //    frmNewBattSched2.Move 0, 0
        //frmNewBattSched2.DefInstance.Activate();
        //    'MDIForm1.Arrange vbCascade
        //
        //}
        [UpgradeHelpers.Events.Handler]
        ...
        //
        //}
        internal void frmBatt2SchedNew_Activated(Object eventSender, System.EventArgs eventArgs)
        {
        ...
        //UPGRADE_WARNING: (2065) Form event frmBatt2SchedNew.Deactivate has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
        [UpgradeHelpers.Events.Handler]
        internal void frmBatt2SchedNew_Deactivate(Object eventSender, System.EventArgs eventArgs)
        {
            //Call Global Refresh Form subroutine
            //to refresh displayed data on open forms
            ...
            using (var async1 = this.Async(true))
            {
                ...
                if (ViewModel.lbPosam[Index].Text == "")
                {
                    ...
                    if (Source.Name == "pnSelected")
                    {
                        ...
                        async1.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPosition[Index].Text));
                        async1.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(tempNormalized1 =>
                            {
                    ...
                    else
                    {
                        ...
                        if (AMPM == "AM")
                        {
                            ...
                            async1.Append<PTSProject.frmBatt2SchedNew.MoveEmployeeStruct>(() => MoveEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam2, ViewModel.lbPosition[Index].Text));
                            async1.Append<PTSProject.frmBatt2SchedNew.MoveEmployeeStruct>(tempNormalized3 =>
                                {
            ...
            using (var async1 = this.Async(true))
            {
                ...
                if (ViewModel.lbPospm[Index].Text == "")
                {
                    ...
                    if (Source.Name == "pnSelected")
                    {
                        ...
                        string tempRefParam = Convert.ToString(ViewModel.pnSelected.Tag);
                        async1.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPositionPM[Index].Text));
                        async1.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(tempNormalized1 =>
                            {
...
frmDailyStaffing.DefInstance);
 ...
 frmException1.DefInstance);
                ...
                frmException1.DefInstance.ViewModel.sprExcept.PrintSheet(null);
                //frmException1.DefInstance.ViewModel.sprExcept.Action = (FarPoint.ViewModels.FPActionConstants)32;
                ViewManager.DisposeView(frmException1.DefInstance);
            }
        }
                ...
                async1.Append(() =>
                    {
                        using (var async2 = this.Async())
                        {
                            ...
                            {
                                var returningValue = default(PTSProject.modGlobal.ExtendLeaveStruct);
                                ...
                                async2.Append<PTSProject.modGlobal.ExtendLeaveStruct>(tempNormalized9 =>
                                    {
                                        returningValue = tempNormalized9;
                                    });
                                async2.Append(() =>
                                    {
                                        Response = returningValue.returnValue;
                                        Empid = returningValue.Empid;
                                        if (Response != 0)
                                        {
                                        }
                                        else
                                    ...
                                    async2.Append(() =>
                                        {
                                            using (var async3 = this.Async())
                                            {
                                                ...
                                                async3.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[Convert
                                                ...
                                                async3.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(tempNormalized7 =>
                                                    {
                                                ...
                                                async3.Append(() =>
                                                    {
                                                        using (var async4 = this.Async())
                                                        {
                                                            ...
                                                            UnitID = FindUnit(UpgradeHelpers.Helpers.ControlArrayHelper.GetControlIndex(ViewModel.SelectedLabel)).ToString();
                                                            async4.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[
                                                            ...
                                                            async4.Append<PTSProject.frmBatt2SchedNew.ScheduleEmployeeStruct>(tempNormalized5 =>
                                                                {
...
frmTransReport.DefInstance);
        ...
        public static frmBatt2SchedNew DefInstance
        {
            get
            {
                if (Shared.m_vb6FormDefInstance == null)
        ...
        public static frmBatt2SchedNew CreateInstance()
        {
            PTSProject.frmBatt2SchedNew theInstance = Shared.Container.Resolve<frmBatt2SchedNew>();
        ...
        : UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmBatt2SchedNewViewModel>, UpgradeHelpers.Interfaces.IInitializable
    {
            ...
            Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
        {
            ...
            public virtual frmBatt2SchedNew m_vb6FormDefInstance { get; set; }
