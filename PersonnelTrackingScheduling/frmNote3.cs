...
namespace PTSProject
{
	...
	public partial class frmNote3
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNote3ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmNote3));
		...
		private void frmNote3_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		private void Form_Load()
		{
			...
			try
			{
				...
				strSQL = strSQL + " Where battalion_code = '3' And shift_start = '" + modGlobal.Shared.gNoteDate + " 12:00AM" + "'";
		...
		public static frmNote3 DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmNote3 CreateInstance()
		{
			PTSProject.frmNote3 theInstance = Shared.Container.Resolve< frmNote3>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNote3ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmNote3 m_vb6FormDefInstance { get; set; }
