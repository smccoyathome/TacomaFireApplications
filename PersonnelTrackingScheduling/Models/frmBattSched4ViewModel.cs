...
namespace PTSProject.ViewModels
{
	...
	[UpgradeHelpers.Helpers.Logic(Type = typeof(PTSProject.frmBattSched4))]
	public class frmBattSched4ViewModel
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		{
			base.Build(ctx);
			var _frmUnit_15 = ctx.Resolve<UpgradeHelpers.BasicViewModels.GroupBoxViewModel>();
			...
			var _frmUnit_16 = ctx.Resolve<UpgradeHelpers.BasicViewModels.GroupBoxViewModel>();
			var _frmUnit_17 = ctx.Resolve<UpgradeHelpers.BasicViewModels.GroupBoxViewModel>();
			...
			var _frmUnit_14 = ctx.Resolve<UpgradeHelpers.BasicViewModels.GroupBoxViewModel>();
			...
			this.calSchedDate.TabIndex = 235;
			...
			this.sick_leave_usage = ctx.Resolve<UpgradeHelpers.BasicViewModels.ToolStripMenuItemViewModel>();
			// 
			// sick_leave_usage
			// 
			this.sick_leave_usage.Available = true;
			this.sick_leave_usage.Enabled = true;
			this.sick_leave_usage.Text = "Sick Leave Usage";
			...
			this.cmdAvailToWork.TabIndex = 331;
			...
			this.cmdSwitch4.TabIndex = 172;
			this.cmdSwitch4.Text = "Batt &4 Sched";
			this.Text = "Battalion 5 - Reserve Unit Scheduler";
			this.MinUnitPos = 0;
			this.MaxUnitPos = 0;
			this.AllNoClick = 0;
			...
			lbUnit[11].TabIndex = 89;
			lbUnit[11].Text = "DEFIANCE";
			...
			lbUnit[10].TabIndex = 277;
			lbUnit[10].Text = "COMMENCE";
			...
			lbUnit[13].TabIndex = 259;
			lbUnit[13].Text = "SQ02";
			lbUnit[17].AllowDrop = true;
			lbUnit[17].BackColor = UpgradeHelpers.Helpers.Color.FromArgb(255, 224, 192);
			lbUnit[17].Font = ctx.Resolve<UpgradeHelpers.Helpers.Font>("Arial", 7.8f, UpgradeHelpers.
					Helpers.FontStyle.Bold | UpgradeHelpers.Helpers.FontStyle.Regular, UpgradeHelpers.Helpers.GraphicsUnit.Point, 0);
			lbUnit[17].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			lbUnit[17].Name = "_lbUnit_17";
			lbUnit[17].TabIndex = 179;
            lbUnit[17].Text = "AID09";
			lbUnit[16].AllowDrop = true;
			lbUnit[16].BackColor = UpgradeHelpers.Helpers.Color.FromArgb(255, 224, 192);
			lbUnit[16].Font = ctx.Resolve<UpgradeHelpers.Helpers.Font>("Arial", 7.8f, UpgradeHelpers.
					Helpers.FontStyle.Bold | UpgradeHelpers.Helpers.FontStyle.Regular, UpgradeHelpers.Helpers.GraphicsUnit.Point, 0);
			lbUnit[16].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			lbUnit[16].Name = "_lbUnit_16";
			lbUnit[16].TabIndex = 197;
			lbUnit[16].Text = "SQ05";
			lbUnit[14].AllowDrop = true;
			lbUnit[14].BackColor = UpgradeHelpers.Helpers.Color.FromArgb(255, 224, 192);
			lbUnit[14].Font = ctx.Resolve<UpgradeHelpers.Helpers.Font>("Arial", 7.8f, UpgradeHelpers.
					Helpers.FontStyle.Bold | UpgradeHelpers.Helpers.FontStyle.Regular, UpgradeHelpers.Helpers.GraphicsUnit.Point, 0);
			lbUnit[14].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			lbUnit[14].Name = "_lbUnit_14";
			lbUnit[14].TabIndex = 295;
			lbUnit[14].Text = "SQ03";
			...
			lbUnit[12].TabIndex = 313;
			lbUnit[12].Text = "SQ01";
			lbUnit[15].AllowDrop = true;
			lbUnit[15].BackColor = UpgradeHelpers.Helpers.Color.FromArgb(255, 224, 192);
			lbUnit[15].Font = ctx.Resolve<UpgradeHelpers.Helpers.Font>("Arial", 7.8f, UpgradeHelpers.
					Helpers.FontStyle.Bold | UpgradeHelpers.Helpers.FontStyle.Regular, UpgradeHelpers.Helpers.GraphicsUnit.Point, 0);
			lbUnit[15].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			lbUnit[15].Name = "_lbUnit_15";
			lbUnit[15].TabIndex = 215;
			lbUnit[15].Text = "SQ04";
			lbPosition = ctx.Resolve<System.Collections.Generic.IList<UpgradeHelpers.BasicViewModels.LabelViewModel>>(70);
			...
			lbPosition[18].TabIndex = 1;
			lbPosition[18].Text = "INCHG";
			...
			lbPosition[10].TabIndex = 47;
			lbPosition[10].Text = "OFF";
			...
			lbPosition[44].TabIndex = 85;
			lbPosition[44].Text = "MRNFF";
			...
			lbPosition[43].TabIndex = 84;
			lbPosition[43].Text = "PILOT";
			...
			lbPosition[42].TabIndex = 83;
			lbPosition[42].Text = "OFF";
			...
			lbPosition[39].TabIndex = 274;
			lbPosition[39].Text = "PILOT";
			...
			lbPosition[38].TabIndex = 273;
			lbPosition[38].Text = "OFF";
			...
			lbPosition[37].TabIndex = 158;
			lbPosition[37].Text = "4TH";
			...
			lbPosition[36].TabIndex = 157;
			lbPosition[36].Text = "3RD";
			...
			lbPosition[35].TabIndex = 156;
			lbPosition[35].Text = "DR";
			...
			lbPosition[34].TabIndex = 155;
			lbPosition[34].Text = "OFF";
			...
			lbPosition[33].TabIndex = 141;
			lbPosition[33].Text = "4TH";
			...
			lbPosition[32].TabIndex = 140;
			lbPosition[32].Text = "3RD";
			...
			lbPosition[31].TabIndex = 139;
			lbPosition[31].Text = "DR";
			...
			lbPosition[30].TabIndex = 138;
			lbPosition[30].Text = "OFF";
			...
			lbPosition[27].TabIndex = 109;
			lbPosition[27].Text = "DR";
			...
			lbPosition[28].TabIndex = 108;
			lbPosition[28].Text = "3RD";
			...
			lbPosition[29].TabIndex = 107;
			lbPosition[29].Text = "4TH";
			...
			lbPosition[26].TabIndex = 102;
			lbPosition[26].Text = "OFF";
			...
			lbPosition[25].TabIndex = 123;
			lbPosition[25].Text = "4TH";
			...
			lbPosition[24].TabIndex = 122;
			lbPosition[24].Text = "3RD";
			...
			lbPosition[23].TabIndex = 121;
			lbPosition[23].Text = "DR";
			...
			lbPosition[22].TabIndex = 120;
			lbPosition[22].Text = "OFF";
			...
			lbPosition[53].TabIndex = 258;
			lbPosition[53].Text = "4TH";
			lbPosition[53].Visible = false;
			...
			lbPosition[52].TabIndex = 257;
			lbPosition[52].Text = "3RD";
			lbPosition[52].Visible = false;
			...
			lbPosition[51].TabIndex = 256;
			lbPosition[51].Text = "DR";
			...
			lbPosition[50].TabIndex = 255;
			lbPosition[50].Text = "OFF";
			...
			lbPosition[68].TabIndex = 181;
			lbPosition[68].Text = "3RD";
			lbPosition[68].Visible = false;
			...
			lbPosition[69].TabIndex = 180;
			lbPosition[69].Text = "4TH";
			lbPosition[69].Visible = false;
			...
			lbPosition[64].TabIndex = 199;
			lbPosition[64].Text = "3RD";
			lbPosition[64].Visible = false;
			...
			lbPosition[57].TabIndex = 294;
			lbPosition[57].Text = "4TH";
			...
			lbPosition[56].TabIndex = 293;
			lbPosition[56].Text = "3RD";
			lbPosition[56].Visible = false;
			...
			lbPosition[55].TabIndex = 292;
			lbPosition[55].Text = "DR";
			...
			lbPosition[54].TabIndex = 291;
			lbPosition[54].Text = "OFF";
			...
			lbPosition[49].TabIndex = 312;
			lbPosition[49].Text = "4TH";
			lbPosition[49].Visible = false;
			...
			lbPosition[48].TabIndex = 311;
			lbPosition[48].Text = "3RD";
			...
			lbPosition[47].TabIndex = 310;
			lbPosition[47].Text = "DR";
			...
			lbPosition[46].TabIndex = 309;
			lbPosition[46].Text = "OFF";
			...
			lbPosition[59].TabIndex = 218;
			lbPosition[59].Text = "DR";
			...
			lbPosition[60].TabIndex = 217;
			lbPosition[60].Text = "3RD";
			lbPosition[60].Visible = false;
			...
			lbPosition[61].TabIndex = 216;
			lbPosition[61].Text = "4TH";
			lbPosition[61].Visible = false;
			lbPosam = ctx.Resolve<System.Collections.Generic.IList<UpgradeHelpers.BasicViewModels.LabelViewModel>>(70);
			...
			lbPosam[53].TabIndex = 267;
			lbPosam[53].Visible = false;
			...
			lbPosam[52].TabIndex = 266;
			lbPosam[52].Visible = false;
			...
			lbPosam[69].TabIndex = 191;
			lbPosam[69].Visible = false;
			...
			lbPosam[68].TabIndex = 189;
			lbPosam[68].Visible = false;
			...
			lbPosam[64].TabIndex = 205;
			lbPosam[64].Visible = false;
			...
			lbPosam[56].TabIndex = 302;
			lbPosam[56].Visible = false;
			...
			lbPosam[60].TabIndex = 225;
			lbPosam[60].Visible = false;
			...
			lbPosam[58].TabIndex = 221;
			shpPayUpAM = ctx.Resolve<System.Collections.Generic.IList<VB6Helpers.ViewModels.ShapeHelperViewModel>>(70);
			...
			lbPositionPM = ctx.Resolve<System.Collections.Generic.IList<UpgradeHelpers.BasicViewModels.LabelViewModel>>(70);
			...
			lbPositionPM[18].TabIndex = 6;
			lbPositionPM[18].Text = "INCHG";
			...
			lbPositionPM[10].TabIndex = 52;
			lbPositionPM[10].Text = "OFF";
			...
			lbPositionPM[6].TabIndex = 242;
			lbPositionPM[6].Text = "OFF";
			...
			lbPositionPM[44].TabIndex = 88;
			lbPositionPM[44].Text = "MRNFF";
			...
			lbPositionPM[43].TabIndex = 87;
			lbPositionPM[43].Text = "PILOT";
			...
			lbPositionPM[42].TabIndex = 86;
			lbPositionPM[42].Text = "OFF";
			...
			lbPositionPM[41].TabIndex = 281;
			lbPositionPM[41].Text = "4TH";
			...
			lbPositionPM[40].TabIndex = 280;
			lbPositionPM[40].Text = "MRNFF";
			...
			lbPositionPM[39].TabIndex = 279;
			lbPositionPM[39].Text = "PILOT";
			...
			lbPositionPM[38].TabIndex = 278;
			lbPositionPM[38].Text = "OFF";
			...
			lbPositionPM[37].TabIndex = 163;
			lbPositionPM[37].Text = "4TH";
			...
			lbPositionPM[36].TabIndex = 162;
			lbPositionPM[36].Text = "3RD";
			...
			lbPositionPM[35].TabIndex = 161;
			lbPositionPM[35].Text = "DR";
			...
			lbPositionPM[34].TabIndex = 160;
			lbPositionPM[34].Text = "OFF";
			...
			lbPositionPM[33].TabIndex = 144;
			lbPositionPM[33].Text = "4TH";
			...
			lbPositionPM[32].TabIndex = 143;
			lbPositionPM[32].Text = "3RD";
			...
			lbPositionPM[31].TabIndex = 142;
			lbPositionPM[31].Text = "DR";
			...
			lbPositionPM[30].TabIndex = 137;
			lbPositionPM[30].Text = "OFF";
			...
			lbPositionPM[27].TabIndex = 106;
			lbPositionPM[27].Text = "DR";
			...
			lbPositionPM[28].TabIndex = 105;
			lbPositionPM[28].Text = "3RD";
			...
			lbPositionPM[29].TabIndex = 104;
			lbPositionPM[29].Text = "4TH";
			...
			lbPositionPM[26].TabIndex = 101;
			lbPositionPM[26].Text = "OFF";
			...
			lbPositionPM[25].TabIndex = 127;
			lbPositionPM[25].Text = "4TH";
			...
			lbPositionPM[24].TabIndex = 126;
			lbPositionPM[24].Text = "3RD";
			...
			lbPositionPM[23].TabIndex = 125;
			lbPositionPM[23].Text = "DR";
			...
			lbPositionPM[22].TabIndex = 124;
			lbPositionPM[22].Text = "OFF";
			...
			lbPositionPM[53].TabIndex = 263;
			lbPositionPM[53].Text = "4TH";
			...
			lbPositionPM[52].TabIndex = 262;
			lbPositionPM[52].Text = "3RD";
			...
			lbPositionPM[51].TabIndex = 261;
			lbPositionPM[51].Text = "DR";
			...
			lbPositionPM[50].TabIndex = 260;
			lbPositionPM[50].Text = "OFF";
			...
			lbPositionPM[57].TabIndex = 299;
			lbPositionPM[57].Text = "4TH";
			...
			lbPositionPM[56].TabIndex = 298;
			lbPositionPM[56].Text = "3RD";
			...
			lbPositionPM[55].TabIndex = 297;
			lbPositionPM[55].Text = "DR";
			...
			lbPositionPM[54].TabIndex = 296;
			lbPositionPM[54].Text = "OFF";
			...
			lbPositionPM[48].TabIndex = 316;
			lbPositionPM[48].Text = "3RD";
			...
			lbPositionPM[47].TabIndex = 315;
			lbPositionPM[47].Text = "DR";
			...
			lbPositionPM[46].TabIndex = 314;
			lbPositionPM[46].Text = "OFF";
			...
			lbPositionPM[59].TabIndex = 213;
			lbPositionPM[59].Text = "DR";
			...
			lbPositionPM[60].TabIndex = 212;
			lbPositionPM[60].Text = "3RD";
			...
			lbPositionPM[61].TabIndex = 211;
			lbPositionPM[61].Text = "4TH";
			lbPositionPM[61].Visible = false;
			lbPospm = ctx.Resolve<System.Collections.Generic.IList<UpgradeHelpers.BasicViewModels.LabelViewModel>>(70);
			...
			lbPospm[53].TabIndex = 271;
			lbPospm[53].Visible = false;
			...
			lbPospm[52].TabIndex = 270;
			lbPospm[52].Visible = false;
			...
			lbPospm[68].TabIndex = 190;
			lbPospm[68].Visible = false;
			...
			lbPospm[69].TabIndex = 184;
			lbPospm[69].Visible = false;
			...
			lbPospm[64].TabIndex = 204;
			lbPospm[64].Visible = false;
			...
			lbPospm[56].TabIndex = 306;
			lbPospm[56].Visible = false;
			...
			lbPospm[60].TabIndex = 226;
			lbPospm[60].Visible = false;
			...
			lbPospm[58].TabIndex = 222;
			shpPayUpPM = ctx.Resolve<System.Collections.Generic.IList<VB6Helpers.ViewModels.ShapeHelperViewModel>>(70);
			...
			frmUnit = ctx.Resolve<System.Collections.Generic.IList<UpgradeHelpers.BasicViewModels.GroupBoxViewModel>>(18);
			...
			frmUnit[8].TabIndex = 154;
			frmUnit[8].Visible = true;
			frmUnit[14].BackColor = UpgradeHelpers.Helpers.Color.Teal;
			frmUnit[14].Enabled = true;
			frmUnit[14].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			frmUnit[14].Name = "_frmUnit_14";
			frmUnit[14].TabIndex = 136;
			frmUnit[14].Visible = true;
			...
			frmUnit[9].TabIndex = 254;
			frmUnit[9].Visible = true;
			frmUnit[17].BackColor = UpgradeHelpers.Helpers.Color.Teal;
			frmUnit[17].Enabled = true;
			frmUnit[17].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			frmUnit[17].Name = "_frmUnit_17";
			frmUnit[17].TabIndex = 174;
			frmUnit[17].Visible = true;
			frmUnit[16].BackColor = UpgradeHelpers.Helpers.Color.Teal;
			frmUnit[16].Enabled = true;
			frmUnit[16].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			frmUnit[16].Name = "_frmUnit_16";
			frmUnit[16].TabIndex = 192;
			frmUnit[16].Visible = true;
			...
			frmUnit[12].TabIndex = 308;
			frmUnit[12].Visible = true;
			frmUnit[15].BackColor = UpgradeHelpers.Helpers.Color.Teal;
			frmUnit[15].Enabled = true;
			frmUnit[15].ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			frmUnit[15].Name = "_frmUnit_15";
			frmUnit[15].TabIndex = 210;
			frmUnit[15].Visible = true;
			this.Name = "PTSProject.frmBattSched4";
			IsMdiChild = true;
		}
		...
		public virtual UpgradeHelpers.BasicViewModels.ToolStripMenuItemViewModel sick_leave_usage { get; set; }
