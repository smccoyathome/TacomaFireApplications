...
namespace PTSProject.ViewModels
{
	...
	[UpgradeHelpers.Helpers.Logic(Type = typeof(PTSProject.frmPMVacationScheduler))]
	public class frmPMVacationSchedulerViewModel
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		public override void Build(UpgradeHelpers.Interfaces.IIocContainer ctx)
		{
			...
			this.Text = "Paramedic Vacation Scheduler";
			this.MaxAllowed = 0;
			this.CalendarLoading = false;
			this.FirstTime = false;
			this.Name = "PTSProject.frmPMVacationScheduler";
			IsMdiChild = true;
		}
