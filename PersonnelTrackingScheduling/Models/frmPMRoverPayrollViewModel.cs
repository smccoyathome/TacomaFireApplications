...
namespace PTSProject.ViewModels
{
	...
	[UpgradeHelpers.Helpers.Logic(Type = typeof(PTSProject.frmPMRoverPayroll))]
	public class frmPMRoverPayrollViewModel
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		public override void Build(UpgradeHelpers.Interfaces.IIocContainer ctx)
		{
			...
			this.txtWBSElement2.TabIndex = 55;
			...
			this.txtCostCenter2.TabIndex = 54;
			...
			this.txtCostCenter1.TabIndex = 32;
			...
			this.txtWBSElement1.TabIndex = 31;
			...
			this.sprEmployeeList.TabIndex = 83;
			...
			this.sprEmployeeList_Sheet1.Columns.Get(0).StyleName = "CheckBox735636234755951877771";
			...
			this.sprTimeSheet_Sheet1.Columns.Get(8).StyleName = "Static1171636234756478201506";
			this.sprTimeSheet_Sheet1.Columns.Get(8).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(9).StyleName = "Static1171636234756478201506";
			this.sprTimeSheet_Sheet1.Columns.Get(9).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(10).StyleName = "Static1171636234756478201506";
			this.sprTimeSheet_Sheet1.Columns.Get(10).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(11).StyleName = "Static1171636234756478201506";
			this.sprTimeSheet_Sheet1.Columns.Get(11).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(12).StyleName = "Static1171636234756478201506";
			this.sprTimeSheet_Sheet1.Columns.Get(12).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(13).StyleName = "Static1171636234756478201506";
			this.sprTimeSheet_Sheet1.Columns.Get(13).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(14).StyleName = "Static1171636234756478201506";
			...
			this.Text = "EMS Paramedic Rover Payroll";
			this.ReportDate = "";
			...
			Label2[1].TabIndex = 13;
			Label2[1].Text = "W E E K 1";
			namedStyle1 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color50636234756155565906", "DataAreaDefault");
			...
			namedStyle2 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text299636234756155575671", "DataAreaDefault");
			...
			namedStyle3 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color50636234756231654786", "DataAreaDefault");
			...
			namedStyle4 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text299636234756231664551", "DataAreaDefault");
			...
			namedStyle5 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color59636234756478133151", "DataAreaDefault");
			...
			namedStyle6 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text337636234756478152681", "DataAreaDefault");
			...
			namedStyle7 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1171636234756478201506");
			...
			namedStyle8 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1728636234756478250331");
			...
			namedStyle9 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1768636234756478269861");
			...
			namedStyle10 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1827636234756478279626");
			...
			namedStyle11 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1867636234756478289391");
			...
			namedStyle12 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1932636234756478299156");
			...
			namedStyle13 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1972636234756478299156");
			...
			namedStyle14 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3030636234756478474926");
			...
			namedStyle15 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3070636234756478484691");
			...
			namedStyle16 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3156636234756478494456");
			...
			namedStyle17 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3196636234756478504221");
			...
			namedStyle18 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3234636234756478523751");
			...
			namedStyle19 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3274636234756478533516");
			...
			namedStyle20 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3352636234756478543281");
			...
			namedStyle21 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx156636234756478748346");
			...
			namedStyle22 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static196636234756478758111");
			...
			namedStyle23 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color236636234756478767876");
			...
			namedStyle24 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx303636234756478777641");
			...
			namedStyle25 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static321636234756478777641");
			...
			namedStyle26 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx359636234756478777641");
			...
			namedStyle27 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static377636234756478787406");
			...
			namedStyle28 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1108636234756478894821");
			...
			namedStyle29 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1126636234756478904586");
			...
			namedStyle30 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1211636234756478914351");
			...
			namedStyle31 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1251636234756478924116");
			...
			namedStyle32 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1312636234756478933881");
			...
			namedStyle33 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2732636234756479207301");
			...
			namedStyle34 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx928636234756481033356");
			...
			namedStyle35 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static968636234756481043121");
			...
			namedStyle36 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3312636234756478533516");
			...
			namedStyle37 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1069636234756481072416");
			...
			namedStyle38 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1133636234756481091946");
			...
			namedStyle39 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2307636234756481316541");
			...
			namedStyle40 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2347636234756481326306");
			...
			namedStyle41 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx333636234756483064476");
			...
			namedStyle42 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static966636234756483152361");
			...
			namedStyle43 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1046636234756483162126");
			...
			namedStyle44 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1158636234756483171891");
			...
			namedStyle45 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1308636234756483191421");
			...
			namedStyle46 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1326636234756483201186");
			...
			namedStyle47 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color50636234755951848476", "DataAreaDefault");
			...
			namedStyle48 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text315636234755951848476", "DataAreaDefault");
			...
			namedStyle49 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("CheckBox735636234755951877771");
			...
			this.Name = "PTSProject.frmPMRoverPayroll";
			IsMdiChild = true;
