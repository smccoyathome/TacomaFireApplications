...
namespace PTSProject.ViewModels
{
	...
	[UpgradeHelpers.Helpers.Logic(Type = typeof(PTSProject.frmPayrollBCStaff))]
	public class frmPayrollBCStaffViewModel
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		public override void Build(UpgradeHelpers.Interfaces.IIocContainer ctx)
		{
			...
			this.lbApprovedOn = ctx.Resolve<UpgradeHelpers.BasicViewModels.LabelViewModel>();
			// 
			// lbApprovedOn
			// 
			this.lbApprovedOn.BackColor = UpgradeHelpers.Helpers.Color.Transparent;
			this.lbApprovedOn.Font = ctx.Resolve<UpgradeHelpers.Helpers.Font>("Arial", 7.8F, UpgradeHelpers.Helpers.FontStyle.Bold, UpgradeHelpers.Helpers.GraphicsUnit.Point, ((byte)(0)));
			this.lbApprovedOn.ForeColor = UpgradeHelpers.Helpers.Color.Yellow;
			this.lbApprovedOn.Name = "lbApprovedOn";
			this.lbApprovedOn.TabIndex = 85;
			...
			this.Label1.Text = "Note:  OK Checked = Timecard has been Approved";
			...
			this.sprEmployeeList.TabIndex = 78;
			...
			this.sprEmployeeList_Sheet1.Columns.Get(0).StyleName = "CheckBox735636234751587840681";
			...
			this.sprTimeSheet_Sheet1.Columns.Get(8).StyleName = "Static1171636234751868711376";
			this.sprTimeSheet_Sheet1.Columns.Get(8).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(9).StyleName = "Static1171636234751868711376";
			this.sprTimeSheet_Sheet1.Columns.Get(9).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(10).StyleName = "Static1171636234751868711376";
			this.sprTimeSheet_Sheet1.Columns.Get(10).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(11).StyleName = "Static1171636234751868711376";
			this.sprTimeSheet_Sheet1.Columns.Get(11).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(12).StyleName = "Static1171636234751868711376";
			this.sprTimeSheet_Sheet1.Columns.Get(12).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(13).StyleName = "Static1171636234751868711376";
			this.sprTimeSheet_Sheet1.Columns.Get(13).Width = 42F;
			this.sprTimeSheet_Sheet1.Columns.Get(14).StyleName = "Static1171636234751868711376";
			...
			this.cmdApprove.Font = ctx.Resolve<UpgradeHelpers.Helpers.Font>("Arial", 9F, UpgradeHelpers.Helpers.FontStyle.Bold, UpgradeHelpers.Helpers.GraphicsUnit.Point, ((byte)(0)));
			this.cmdApprove.ForeColor = UpgradeHelpers.Helpers.SystemColors.ControlText;
			this.cmdApprove.Name = "cmdApprove";
			this.cmdApprove.TabIndex = 83;
			this.cmdApprove.Text = "Approve Timecard";
			...
			Label3[6].Font = ctx.Resolve<UpgradeHelpers.Helpers.Font>("Arial", 9F, UpgradeHelpers.Helpers.FontStyle.Bold, UpgradeHelpers.Helpers.GraphicsUnit.Point, ((byte)(0)));
			Label3[6].ForeColor = UpgradeHelpers.Helpers.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(192)))), ((int)(((byte)(192)))));
			Label3[6].Name = "_Label3_6";
			Label3[6].TabIndex = 87;
			Label3[6].Text = "Select Payroll Year";
			...
			Label2[0].TabIndex = 81;
			Label2[0].Text = "W E E K 2";
			namedStyle1 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color50636234751670843181", "DataAreaDefault");
			...
			namedStyle2 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text299636234751670852946", "DataAreaDefault");
			...
			namedStyle3 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color50636234751752048921", "DataAreaDefault");
			...
			namedStyle4 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text299636234751752058686", "DataAreaDefault");
			...
			namedStyle5 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color59636234751868672316", "DataAreaDefault");
			...
			namedStyle6 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text337636234751868682081", "DataAreaDefault");
			...
			namedStyle7 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1171636234751868711376");
			...
			namedStyle8 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1728636234751868769966");
			...
			namedStyle9 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1768636234751868779731");
			...
			namedStyle10 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1827636234751868789496");
			...
			namedStyle11 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1867636234751868799261");
			...
			namedStyle12 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1932636234751868809026");
			...
			namedStyle13 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1972636234751868818791");
			...
			namedStyle14 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3030636234751869043386");
			...
			namedStyle15 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3070636234751869053151");
			...
			namedStyle16 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3156636234751869062916");
			...
			namedStyle17 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3196636234751869062916");
			...
			namedStyle18 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3234636234751869072681");
			...
			namedStyle19 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3274636234751869082446");
			...
			namedStyle20 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3352636234751869092211");
			...
			namedStyle21 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx156636234751869287511");
			...
			namedStyle22 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static196636234751869297276");
			...
			namedStyle23 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color236636234751869307041");
			...
			namedStyle24 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx303636234751869307041");
			...
			namedStyle25 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static321636234751869316806");
			...
			namedStyle26 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx359636234751869316806");
			...
			namedStyle27 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static377636234751869326571");
			...
			namedStyle28 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1108636234751869453516");
			...
			namedStyle29 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1126636234751869453516");
			...
			namedStyle30 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1211636234751869463281");
			...
			namedStyle31 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1251636234751869473046");
			...
			namedStyle32 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1312636234751869482811");
			...
			namedStyle33 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2732636234751869736701");
			...
			namedStyle34 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx928636234751871640876");
			...
			namedStyle35 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static968636234751871650641");
			...
			namedStyle36 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3312636234751869082446");
			...
			namedStyle37 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1069636234751871670171");
			...
			namedStyle38 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1133636234751871679936");
			...
			namedStyle39 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2307636234751871875236");
			...
			namedStyle40 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2347636234751871875236");
			...
			namedStyle41 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx333636234751873505991");
			...
			namedStyle42 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static966636234751873593876");
			...
			namedStyle43 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1046636234751873613406");
			...
			namedStyle44 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1158636234751873623171");
			...
			namedStyle45 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1308636234751873642701");
			...
			namedStyle46 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1326636234751873642701");
			...
			namedStyle47 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color50636234751587821151", "DataAreaDefault");
			...
			namedStyle48 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text315636234751587830916", "DataAreaDefault");
			...
			namedStyle49 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("CheckBox735636234751587840681");
			...
			this.Name = "PTSProject.frmPayrollBCStaff";
			IsMdiChild = true;
		...
		public virtual UpgradeHelpers.BasicViewModels.LabelViewModel lbApprovedOn { get; set; }
		...
		[UpgradeHelpers.Helpers.StateManagement(UpgradeHelpers.Helpers.StateManagementValues.ServerOnly)]
		public virtual System.Int32 CurrEmpSAPID { get; set; }
		...
		[UpgradeHelpers.Helpers.StateManagement(UpgradeHelpers.Helpers.StateManagementValues.ServerOnly)]
		public virtual System.String CurrApproveDate { get; set; }
