...
namespace PTSProject.ViewModels
{
	...
	[UpgradeHelpers.Helpers.Logic(Type = typeof(PTSProject.frmException3))]
	public class frmException3ViewModel
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		public override void Build(UpgradeHelpers.Interfaces.IIocContainer ctx)
		{
			...
			this.sprExcept_Sheet1.Cells.Get(1, 0).Value = "Battalion 3 Time Card Exception Report";
			...
			this.Text = "Battalion 3 Time Card Exception Report";
			this.FirstTime = 0;
			namedStyle1 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color65636234707285006901", "DataAreaDefault");
			...
			namedStyle2 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text418636234707285026431", "DataAreaDefault");
			...
			namedStyle3 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Font120636234707285075256");
			...
			namedStyle4 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static138636234707285075256");
			...
			namedStyle5 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static193636234707285094786");
			...
			namedStyle6 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Font831636234707285407266");
			...
			namedStyle7 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static849636234707285417031");
			...
			namedStyle8 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1330636234707285827161");
			...
			namedStyle9 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1364636234707285875986");
			...
			namedStyle10 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1402636234707285895516");
			...
			namedStyle11 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1602636234707286159171");
			...
			namedStyle12 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1640636234707286178701");
			...
			namedStyle13 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1734636234707286237291");
			...
			namedStyle14 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1086636234707304468546");
			...
			namedStyle15 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1389636234707304790791");
			...
			namedStyle16 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1555636234707312261016");
			...
			namedStyle17 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1611636234707312348901");
			...
			this.Name = "PTSProject.frmException3";
			IsMdiChild = true;
