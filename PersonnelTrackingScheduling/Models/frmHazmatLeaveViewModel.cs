...
namespace PTSProject.ViewModels
{
	...
	[UpgradeHelpers.Helpers.Logic(Type = typeof(PTSProject.frmHazmatLeave))]
	public class frmHazmatLeaveViewModel
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		public override void Build(UpgradeHelpers.Interfaces.IIocContainer ctx)
		{
			...
			this.Text = "Hazmat Leave";
			this.ThisYear = 0;
			this.ThisMonth = 0;
			namedStyle1 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color50636234715108773726", "DataAreaDefault");
			...
			namedStyle2 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Text401636234715108783491", "DataAreaDefault");
			...
			namedStyle3 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1183636234715108851846");
			...
			namedStyle4 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1239636234715108871376");
			...
			namedStyle5 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1297636234715108881141");
			...
			namedStyle6 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1353636234715108890906");
			...
			namedStyle7 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1411636234715108900671");
			...
			namedStyle8 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1525636234715108920201");
			...
			namedStyle9 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1867636234715108988556");
			...
			namedStyle10 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1923636234715108998321");
			...
			namedStyle11 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2010636234715109017851");
			...
			namedStyle12 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2066636234715109027616");
			...
			namedStyle13 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2125636234715109037381");
			...
			namedStyle14 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2240636234715109066676");
			...
			namedStyle15 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Font2801636234715109193621");
			...
			namedStyle16 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2850636234715109203386");
			...
			namedStyle17 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2890636234715109213151");
			...
			namedStyle18 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Color2912636234715109213151");
			...
			namedStyle19 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2930636234715109222916");
			...
			namedStyle20 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3128636234715109271741");
			...
			namedStyle21 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static3168636234715109281506");
			...
			namedStyle22 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3217636234715109281506");
			...
			namedStyle23 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx3494636234715109310801");
			...
			namedStyle24 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static2451636234715109691636");
			...
			namedStyle25 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2489636234715109691636");
			...
			namedStyle26 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx2659636234715109720931");
			...
			namedStyle27 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("BorderEx1700636234715110092001");
			...
			namedStyle28 = ctx.Resolve<FarPoint.ViewModels.NamedStyle>("Static1506636234715110580251");
			...
			this.Name = "PTSProject.frmHazmatLeave";
			IsMdiChild = true;
