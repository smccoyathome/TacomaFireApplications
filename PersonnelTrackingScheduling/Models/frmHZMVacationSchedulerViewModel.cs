...
namespace PTSProject.ViewModels
{
	...
	[UpgradeHelpers.Helpers.Logic(Type = typeof(PTSProject.frmHZMVacationScheduler))]
	public class frmHZMVacationSchedulerViewModel
		: UpgradeHelpers.Helpers.FormBaseViewModel
	{
		...
		public override void Build(UpgradeHelpers.Interfaces.IIocContainer ctx)
		{
			...
			this.Text = "Hazmat Vacation Scheduler";
			this.MaxAllowed = 0;
			this.CalendarLoading = false;
			this.FirstTime = false;
			this.Name = "PTSProject.frmHZMVacationScheduler";
			IsMdiChild = true;
		}
