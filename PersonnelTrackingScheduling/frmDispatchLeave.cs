...
namespace PTSProject
{
	...
	public partial class frmDispatchLeave
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmDispatchLeaveViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmDispatchLeave));
		...
		private void frmDispatchLeave_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void FormatReport()
		{
			...
			oCmd.CommandText = "spSelect_DispatchMonthlySchedLeave " + ViewModel.ThisYear.ToString() + ", " + ViewModel.ThisMonth.ToString() + " ";
		...
		public static frmDispatchLeave DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmDispatchLeave CreateInstance()
		{
			PTSProject.frmDispatchLeave theInstance = Shared.Container.Resolve< frmDispatchLeave>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmDispatchLeaveViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmDispatchLeave m_vb6FormDefInstance { get; set; }
