...
namespace PTSProject
{
	...
	public partial class frmNote2
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNote2ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmNote2));
		...
		private void frmNote2_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
			...
			try
			{
				...
				if ( ViewModel.NoteID == 0)
				{
					...
					if (strNote != "")
					{
						...
						oCmd.ExecuteNonQuery(new object[] { ViewModel.NoteID, modGlobal.Shared.gNoteDate + " 12:00AM", "2", strNote });
					}
				}
				else
				{
		...
		private void Form_Load()
		{
			...
			try
			{
				...
				strSQL = strSQL + " Where battalion_code = '2' And shift_start = '" + modGlobal.Shared.gNoteDate + " 12:00AM" + "'";
		...
		public static frmNote2 DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmNote2 CreateInstance()
		{
			PTSProject.frmNote2 theInstance = Shared.Container.Resolve< frmNote2>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNote2ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmNote2 m_vb6FormDefInstance { get; set; }
