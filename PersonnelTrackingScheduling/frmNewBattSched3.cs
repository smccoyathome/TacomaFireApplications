...
//using PTSProject.Extensions;

namespace PTSProject
{

	public partial class frmNewBattSched3
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNewBattSched3ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmNewBattSched3));
		...
		//    sBatt = "2"
		//
		//    shpLineup.Visible = False
		//    cmdSetLineUp.Caption = "  Lineup Complete"
		//    cmdSetLineUp.Enabled = True
		//
		//    If cSchedule.GetBattLineupCompleteByBattDate(sBatt, sDate) Then
		//        shpLineup.Visible = True
		//        cmdSetLineUp.Caption = "  Lineup Not Done"
		...
		public void CheckSignOff(string CheckDate)
		{
			...
			oCmd.Connection = modGlobal.oConn;
			oCmd.CommandType = CommandType.Text;
			oCmd.CommandText = "sp_GetSignOff '" + CheckDate + "','3'";
			ADORecordSetHelper oRec = ADORecordSetHelper.Open(oCmd, "");
			if ( !oRec.EOF )
			{
...
dlgSpecialAssign.DefInstance, true);
									...
									async2.Append(() =>
										{
												...
												//******************************************
												//Determine Timecode
												//NO LONGER UPDATING TIMECODE FOR SA
												//    If gDebitDefault Then
												//        TimeCode = "DDF"
												//    ElseIf gTradeDefault Then
												//        TimeCode = "TRD"
												//    Else
												//        TimeCode = "REG"
												//    End If
                ...
                {
                    {
                        ...
                        if (modGlobal.Shared.gFullShift != 0)
                        {
                            ...
                            async1.Append<DialogResult, MoveEmployeeStruct>((responseValue) =>
                            {
                                ...
                                {
                                    return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmNewBattSched3.MoveEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
                                }
                                        ...
                                        if (!oRec.EOF)
                                        {
                                            ...
                                            for (int i = 1; i <= 11; i++)
                                            {
                                                ...
                                                if (oRec.EOF)
                                                {
                                                    ...
                                                    {
                                                        PayUp = 0;
                                                        return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmNewBattSched3.MoveEmployeeStruct(
                                                           )
                        ...
                        return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmNewBattSched3.MoveEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
                    }
                }
                catch
                {
        ...
        public DeleteScheduleStruct DeleteSchedule(string Empid, string ShiftDate)
		{
                ...
                if (modGlobal.ErrorControl() == modGlobal.eFATALERROR)
						{
                    return new PTSProject.frmNewBattSched3.DeleteScheduleStruct()
				...
				{
					{
						...
						if ( !oRec.EOF )
						{
							...
							else
							{
                                ...
                                return this.Return< ScheduleEmployeeStruct>(() => new PTSProject.frmNewBattSched3.ScheduleEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
							}
						}
                        ...
                        return this.Return< ScheduleEmployeeStruct>(() => new PTSProject.frmNewBattSched3.ScheduleEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
					}
				}
				catch
				{
		...
		public void FillLists()
		{
				...
				try
				{
					...
					//Fill Rover list box
					oCmd.CommandText = "sp_SpecialList '" + ShiftStart + "','" + ShiftEnd + "'," + modGlobal.ASGN183ROV.ToString();
					oRec = ADORecordSetHelper.Open(oCmd, "");
					...
					oCmd.CommandText = "sp_SpecialList '" + ShiftStart + "','" + ShiftEnd + "'," + modGlobal.ASGN183DBT.ToString();
					oRec = ADORecordSetHelper.Open(oCmd, "");
					...
					oCmd.CommandText = "spReport_GetDailySchLv '" + StartDate + "','" + EndDate + "','3'";
					oRec = ADORecordSetHelper.Open(oCmd, "");
					...
					oCmd.CommandText = "spReport_GetDailySckLv '" + StartDate + "','" + EndDate + "','3'";
					oRec = ADORecordSetHelper.Open(oCmd, "");
					sName = "";
					CurrName = "";
		...
		public void GetBattSchedule()
		{
				...
				try
				{
					...
					oCmd.CommandText = "spSelect_UnitDrillGroupByBatt " + "'3'";
					oRec = ADORecordSetHelper.Open(oCmd, "");
					...
					oCmd.CommandText = "sp_GetBattSchedule '" + ShiftDate + "','3'";
					oRec = ADORecordSetHelper.Open(oCmd, "");
					if ( oRec.EOF )
					{
		...
		internal void calSchedDate_Click(Object eventSender, System.EventArgs eventArgs)
		{
				...
				ClearSchedule();
						...
						FillLists();
							...
							{
								modGlobal.Shared.BattDateChange = 3;
							}
            for (int i = 0; i <= ViewManager.OpenFormsCount - 1; i++)
                    ...
                    if ( UpgradeHelpers.Helpers.DateTimeHelper.ToString(frmNewBattSched2.DefInstance.ViewModel.calSchedDate.Value.Date) != modGlobal.Shared.gBattSwitchDate)
                        ...
                        frmNewBattSched2.DefInstance.ViewModel.calSchedDate.Value = DateTime.Parse(modGlobal.Shared.gBattSwitchDate);
										...
										else if ( ViewManager.GetOpenFormAt(i).ViewModel.Name == "frmNewBattSched" && modGlobal.Shared.BattDateChange != 1 )
										{
				...
				async1.Append(() =>
					{
                        ...
                        var returningMetodValue636 = DeleteSchedule(Empid, ShiftDate);
										...
										oCmd.ExecuteNonQuery(new object[] { ShiftDate, Empid, modGlobal.ASGN183DBT, "DDF", 0, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
				...
				async1.Append(() =>
					{
                        ...
                        var returningMetodValue681 = DeleteSchedule(Empid, ShiftDate);
										...
										oCmd.CommandType = CommandType.StoredProcedure;
										oCmd.CommandText = "spInsertSchedule";
										oCmd.ExecuteNonQuery(new object[] { ShiftDate, Empid, modGlobal.ASGN183ROV, KOT, 0, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
     ...
     //           if (modGlobal.ErrorControl() == modGlobal.eFATALERROR)
		...
		{
			//Close Battalion Scheduler form
			//This triggers form Unload event

			//    Unload frmnewbattsched
		...
		internal void cmdNotes_Click(Object eventSender, System.EventArgs eventArgs)
		{
            ...
            ViewManager.NavigateToView(
                frmNote3.DefInstance);
            /*            frmNote3.DefInstance.SetBounds(0, 0, 0            	, 0, Stubs._System.Windows.Forms.            	BoundsSpecified.X | Stubs._System.Windows.Forms.BoundsSpecified.Y)*/
				;
		//MDIForm1.Arrange vbCascade
		}
		...
		{
			modGlobal.Shared.gPayRollBatt = "3";
			modGlobal.Shared.gStartTrans = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00AM";
		...
		internal void cmdRefresh_Click(Object eventSender, System.EventArgs eventArgs)
		{
            ...
            for (int i = 0; i <= ViewManager.OpenFormsCount - 1; i++)
                    ...
                    frmNewBattSched.DefInstance.FillLists();
							...
							else if ( ViewManager.GetOpenFormAt(i).ViewModel.Name == "frmNewBattSched2" )
							{
		...
		internal void frmNewBattSched3_Activated(Object eventSender, System.EventArgs eventArgs)
		{
		...
		//UPGRADE_WARNING: (2065) Form event frmNewBattSched3.Deactivate has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
		[UpgradeHelpers.Events.Handler]
		internal void frmNewBattSched3_Deactivate(Object eventSender, System.EventArgs eventArgs)
		{
		//Call Global Refresh Form subroutine
		//to refresh displayed data on open forms
            ...
            using (var async1 = this.Async(true))
            {
                ...
                if (ViewModel.lbPosam[Index].Text == "")
                {
                    ...
                    if (Source.Name == "pnSelected")
                    {
                        ...
                        async1.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPosition[Index].Text));
                        async1.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(tempNormalized1 =>
                            {
            ...
            using (var async1 = this.Async(true))
            {
				...
				if ( ViewModel.lbPospm[Index].Text == "" )
				{
					...
					if ( Source.Name == "pnSelected" )
					{
						...
						string tempRefParam = Convert.ToString(ViewModel.pnSelected.Tag);
						async1.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPositionPM[Index].Text));
						async1.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(tempNormalized1 =>
							{
					...
					else
					{
                        ...
                        if (AMPM == "PM")
                        {
                            ...
                            {
                                var returningMetodValue842 = employee;
                                if (returningMetodValue842.returnValue)
                                {


                                    ShiftDate = returningMetodValue842.ShiftDate;
                                    tempRefParam2 = returningMetodValue842.Empid;
...
frmDailyStaffing.DefInstance);
				...
				async1.Append(() =>
					{
                        ...
                        var returningMetodValue1171 = DeleteSchedule(Empid, ShiftDate);
										Empid = returningMetodValue1171.Empid;
										ShiftDate = returningMetodValue1171.ShiftDate;
										...
										if ( modGlobal.Shared.gFullShift != 0 )
										{
											...
											ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                                            var returningMetodValue1179 = DeleteSchedule(Empid, ShiftDate);
											Empid = returningMetodValue1179.Empid;
											ShiftDate = returningMetodValue1179.ShiftDate;
											oCmd.ExecuteNonQuery(new object[] { ShiftDate, Empid, modGlobal.ASGN183DBT, "DDF", 0, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
 ...
 frmEMSDailySched.DefInstance);
		...
		internal void mnuException_Click(Object eventSender, System.EventArgs eventArgs)
		{
            ...
            for (int i = 0; i <= ViewManager.OpenFormsCount - 1; i++)
					{
							if ( ViewManager.GetOpenFormAt(i).ViewModel.Name == "frmException3" )
							{
                    ...
                    frmException3.DefInstance.ViewModel.sprExcept.setPrintAbortMsg("Printing Batt 3 Exception Report - Click Cancel to quit");
...
frmIndivReport.DefInstance);
 ...
 frmIndSched.DefInstance);
		...
		//UPGRADE_NOTE: (7001) The following declaration (mnuNewBatt3_Click) seems to be dead code More Information: http://www.vbtonet.com/ewis/ewi7001.aspx
		//private void mnuNewBatt3_Click()
		//{
		//MessageBox.Show("This feature is coming soon!", "New Battalion 3", MessageBoxButtons.OK);
		//}
		[UpgradeHelpers.Events.Handler]
									...
									async2.Append(() =>
										{
											using ( var async3 = this.Async() )
											{
                                                ...
                                                async3.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[Convert
												...
												async3.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(tempNormalized7 =>
													{
		...
		internal void mnuPrintAll_Click(Object eventSender, System.EventArgs eventArgs)
		{
				...
				//Test for frmTimeCard3 already open
				for ( int i = 0; i <= ViewManager.OpenFormsCount - 1; i++ )
				{
					if ( ViewManager.GetOpenFormAt(i).ViewModel.Name == "frmTimeCard3" )
					{
						OpenFlag = -1;
					}
					else
            ...
            //Timestamp report and print
            frmTimeCard3.DefInstance.ViewModel.sprBatt.Col = 22 - 1;
            frmTimeCard3.DefInstance.ViewModel.sprBatt.Row = 41;
            frmTimeCard3.DefInstance.ViewModel.sprBatt.Text = DateTime.Now.ToString("M/d/yy HH:mm");
            ...
            frmTimeCard3.DefInstance.ViewModel.sprBatt.setPrintAbortMsg("Printing Batt 3 Time Card Worksheet - Click Cancel to quit");
            ...
            frmTimeCard3.DefInstance.ViewModel.sprBatt.setPrintBorder(false);
            ...
            frmTimeCard3.DefInstance.ViewModel.sprBatt.setPrintColor(true);
            //    frmTimeCard3.sprBatt.PrintOrientation = 2
            frmTimeCard3.DefInstance.ViewModel.sprBatt.PrintSheet(null);
            //frmTimeCard3.DefInstance.ViewModel.sprBatt.Action = (FarPoint.ViewModels.FPActionConstants)32;

            //If frmTimeCard3 was just openned by this procedure, unload it
            if ( ~OpenFlag != 0 )
				{
                ViewManager.DisposeView(
                    frmTimeCard3.DefInstance);
				...
				async1.Append(() =>
					{
                        ...
                        var returningMetodValue1553 = DeleteSchedule(Empid, ShiftDate);
										...
										oCmd.CommandType = CommandType.StoredProcedure;
										oCmd.CommandText = "spInsertSchedule";
										oCmd.ExecuteNonQuery(new object[] { ShiftDate, Empid, modGlobal.ASGN183ROV, "REG", 0, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
 ...
 frmTimeCard3.DefInstance);
                ...
                frmTimeCard3.DefInstance.ViewModel.sprBatt.PrintSheet(null);
                //frmTimeCard3.DefInstance.ViewModel.sprBatt.Action = (FarPoint.ViewModels.FPActionConstants)32;
                ViewManager.DisposeView(frmTimeCard3.DefInstance);
				}
											...
											using ( var async3 = this.Async() )
											{
												...
												if ( modGlobal.Shared.gFullShift != 0 )
												{
													...
													async3.Append<PTSProject.modGlobal.ScheduleLeaveStruct>(tempNormalized3 =>
														{
															var returningMetodValue6 = tempNormalized3;
														


															Response = returningMetodValue6.returnValue;

															Empid = returningMetodValue6.Empid;

															EndDate = returningMetodValue6.LeaveDate;
														});
												}
												async3.Append(() =>
													{
														using ( var async4 = this.Async() )
														{
															...
															UnitID = FindUnit(UpgradeHelpers.Helpers.ControlArrayHelper.GetControlIndex(ViewModel.SelectedLabel)).ToString();
                                                            async4.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[
															...
															async4.Append<PTSProject.frmNewBattSched3.ScheduleEmployeeStruct>(tempNormalized5 =>
																{
...
frmTransReport.DefInstance);
		...
		public static frmNewBattSched3 DefInstance
		{
			get
			{
					if ( Shared.m_vb6FormDefInstance == null )
		...
		public static frmNewBattSched3 CreateInstance()
		{
				PTSProject.frmNewBattSched3 theInstance = Shared.Container.Resolve<frmNewBattSched3>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNewBattSched3ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmNewBattSched3 m_vb6FormDefInstance { get; set; }
