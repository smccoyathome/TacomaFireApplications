...
namespace PTSProject
{
	...
	public partial class frmTimeCard2
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmTimeCard2ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmTimeCard2));
		...
		private void frmTimeCard2_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void FillSpread()
		{
			...
			for (int i = 1; i <= 20; i++)
			{
				...
				{
					case 1 :
						oCmd.CommandText = "spReport_GetUnitBATT '" + StartDate + "','" + EndDate + "','BC02'";
						...
						oCmd.CommandText = "spReport_GetUnitLvBATT '" + StartDate + "','" + EndDate + "','BC02'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 2 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E01'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E01'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 3 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','L01'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','L01'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 4 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E02'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E02'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 5 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E03'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E03'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 6 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E06'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 17;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E06'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 7 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E12'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 17;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E12'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 8 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','L04'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 17;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','L04'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 9 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','M03'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 17;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','M03'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
					...
					case 14 :
						...
						//            Case 16 
						//                'Rovers List 
						//                oCmd.CommandText = "spReport_GetRovers '2','" & ShiftCode & "'" 
						//                Set orec2 = oCmd.Execute 
						//                x = 39 
						//                Do Until orec2.EOF 
						//'                    ps.rdoParameters(2) = oRec2("employee_id") 
						//'                    Set oRec = ps.OpenResultset 
						//                    oCmd.CommandText = "spReport_FindRover '" & StartDate & "','" & EndDate & "','" & orec2("employee_id") & "'" 
						//                    Set oRec = oCmd.Execute 
						//                    Do Until oRec.EOF 
						//                        sprBatt.Col = 7 
						//                        sprBatt.Row = x 
						...
						//                            ChangeFont = True 
						//                        End If 
						//                        CurrName = Trim$(orec2("name_last"]) & " " & Left$(orec2("name_first"), 1) & "." 
						//                        sprBatt.Text = CurrName 
						//                        sprBatt.Col = 8 
						//                        If ChangeFont Then 
						//                            sprBatt.FontBold = True 
						//                            sprBatt.ForeColor = YELLOW 
						...
						//                            End If 
						//                            sprBatt.Col = 11 
						//                            sprBatt.Text = Trim$(oRec("unit_code"]) 
						//                        Else 
						//                            If Clean(oRec("LeaveCode"]) = "TRD" Then 
						//                                sprBatt.Text = Clean(oRec("TimeCode"]) 
						//                                If Clean(oRec("TimeCode"]) = "EDO" Or Clean(oRec("TimeCode"]) = "OTP" Then 
						...
						//            Case 17 
						//                'Debit List 
						//                oCmd.CommandText = "spReport_GetDebits '" & StartDate & "','" & EndDate & "','2'" 
						//                Set orec2 = oCmd.Execute 
						//                x = 39 
						//                Do Until orec2.EOF 
						//                    sprBatt.Col = 13 
						//                    sprBatt.Row = x 
						//                    If Clean(orec2("vacation_bank_flag"]) = 1 Then 
						//                        ChangeFont = True 
						//                    End If 
						//                    CurrName = Trim$(orec2("name_last"]) & " " & Left$(orec2("name_first"), 1) & "." 
						//                    sprBatt.Text = CurrName 
						...
						//                        ChangeFont = False 
						//                    End If 
						//                    If IsNull(orec2("LeaveCode"]) Then 
						//                        sprBatt.Text = Clean(orec2("TimeCode"]) 
						//                        If Clean(orec2("TimeCode"]) = "OTP" Or Clean(orec2("TimeCode"]) = "EDO" Then 
						//                            sprBatt.ForeColor = WHITE 
						//                            sprBatt.BackColor = RED 
						//                        ElseIf Clean(orec2("TimeCode"]) = "DDF" Or Clean(orec2("TimeCode"]) = "UDD" Then 
						//                            sprBatt.ForeColor = WHITE 
						//                            sprBatt.BackColor = BLUE 
						//                        End If 
						//                        sprBatt.Col = 17 
						//                        sprBatt.Text = orec2("unit_code") 
						//                    Else 
						//                        If Clean(orec2("LeaveCode"]) = "TRD" Then 
						//                            sprBatt.Text = Clean(orec2("TimeCode"]) 
						//                            If Clean(orec2("TimeCode"]) = "OTP" Or Clean(orec2("TimeCode"]) = "EDO" Then 
						//                                sprBatt.ForeColor = WHITE 
						//                                sprBatt.BackColor = RED 
						...
						//                            End If 
						//                            sprBatt.Col = 17 
						//                            sprBatt.Text = Clean(orec2("LeaveCode"]) 
						//                            sprBatt.ForeColor = WHITE 
						//                            sprBatt.BackColor = GREEN 
						//                        Else 
						//                            sprBatt.Text = Clean(orec2("LeaveCode"]) 
						...
						//                            sprBatt.ForeColor = WHITE 
						//                            sprBatt.Col = 17 
						//                            sprBatt.Text = Trim$(Clean(orec2("TimeCode"])) 
						//                            If Clean(orec2("TimeCode"]) = "OTP" Or Clean(orec2("TimeCode"]) = "EDO" Then 
						//                                sprBatt.ForeColor = WHITE 
						//                                sprBatt.BackColor = RED 
						//                            ElseIf Clean(orec2("TimeCode"]) = "DDF" Or Clean(orec2("TimeCode"]) = "UDD" Then 
						...
						//                x = 39 
						//                Do Until orec2.EOF 
						//                    oCmd.CommandText = "spReport_Employee '" & orec2("employee_id") & "'" 
						//                    Set oRec = oCmd.Execute 
						//                    Do Until oRec.EOF 
						//                        If Clean(orec2("vacation_bank_flag"]) = 1 Then 
						//                            ChangeFont = True 
						//                        End If 
						//                        If Trim$(Clean(oRec("battalion_code"])) = "2" Then 
						//                            sprBatt.Col = 19 
						//                            sprBatt.Row = x 
						//                            CurrName = Trim$(orec2("name_last"]) & " " & Left$(orec2("name_first"), 1) & "." 
						//                            sprBatt.Text = CurrName 
					...
					case 19 :
						//Retrieve Notes 
						oCmd.CommandText = "spReport_GetBattNote '" + StartDate + "','" + EndDate + "','2'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 28;
						ViewModel.sprBatt.Col = 25;
						...
						break;
					case 20 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E19R'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 39;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E19R'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
		...
		internal void cmdExcept_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			/*			frmException2.DefInstance.SetBounds(0, 0, 0				, 0, Stubs._System.Windows.Forms.				BoundsSpecified.X | Stubs._System.Windows.Forms.BoundsSpecified.Y)*/
			;
		...
		internal void cmdPrint_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			ViewModel.sprBatt.setPrintAbortMsg("Printing Batt 2 Time Card Worksheet - Click Cancel to quit");
		...
		public static frmTimeCard2 DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmTimeCard2 CreateInstance()
		{
			PTSProject.frmTimeCard2 theInstance = Shared.Container.Resolve< frmTimeCard2>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmTimeCard2ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmTimeCard2 m_vb6FormDefInstance { get; set; }
