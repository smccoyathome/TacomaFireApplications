...
namespace PTSProject
{
	...
	public partial class frmHZMVacationScheduler
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmHZMVacationSchedulerViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmHZMVacationScheduler));
		...
		public void SetCalendarShifts()
		{
			...
			frmHZMVacationScheduler.DefInstance.ViewModel.Visible = false;
			...
			oCmd.CommandText = "spSelect_AnnualCalendarStepHZM '" + modGlobal.Shared.gCurrentYear.ToString() + "' ";
			...
			if (oRec.EOF)
			{
				...
				frmHZMVacationScheduler.DefInstance.ViewModel.Visible = true;
				return;
			}
		...
		internal void frmHZMVacationScheduler_Activated(Object eventSender, System.EventArgs eventArgs)
		{
		...
		//UPGRADE_WARNING: (2065) Form event frmHZMVacationScheduler.Deactivate has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
		[UpgradeHelpers.Events.Handler]
		internal void frmHZMVacationScheduler_Deactivate(Object eventSender, System.EventArgs eventArgs)
		{
			//    RefreshActiveForm
		}
		...
		public static frmHZMVacationScheduler DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmHZMVacationScheduler CreateInstance()
		{
			PTSProject.frmHZMVacationScheduler theInstance = Shared.Container.Resolve< frmHZMVacationScheduler>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmHZMVacationSchedulerViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmHZMVacationScheduler m_vb6FormDefInstance { get; set; }
