...
namespace PTSProject
{
	...
	public partial class frmParamedicLeave
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmParamedicLeaveViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmParamedicLeave));
		...
		private void frmParamedicLeave_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void FormatReport2()
		{
			...
			oCmd.CommandText = "spSelect_ParamedicMonthlySchedLeave " + ViewModel.ThisYear.ToString() + ", " + ViewModel.ThisMonth.ToString() + " ";
			ADORecordSetHelper oRec = ADORecordSetHelper.Open(oCmd, "");

			if (oRec.EOF)
			{
				ViewManager.ShowMessage("There are no Staffing Records for this month", "Paramedic Monthly Scheduled Leav Report", UpgradeHelpers.Helpers.BoxButtons.OK);
		...
		internal void cmdPrint_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			ViewModel.sprMonth2.setPrintAbortMsg("Printing Paramedic Monthly Leave Report - Click Cancel to quit");
		...
		public static frmParamedicLeave DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmParamedicLeave CreateInstance()
		{
			PTSProject.frmParamedicLeave theInstance = Shared.Container.Resolve< frmParamedicLeave>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmParamedicLeaveViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmParamedicLeave m_vb6FormDefInstance { get; set; }
