...
namespace PTSProject
{
	...
	public partial class frmException2
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmException2ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmException2));
		...
		private void frmException2_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		//**************************************
		//* Batt 2 Time Card Exception Report  *
		//**************************************
		//ADODB
		...
		public void FillSpread()
		{
			...
			oCmd.CommandText = "spReport_BattExcept '" + StartDate + "','" + EndDate + "','2'";
			...
			CurrRow += 2;
			ViewModel.sprExcept.Row = CurrRow;
			ViewModel.sprExcept.Text = "Notes:";
			CurrRow++;
			...
			oCmd.CommandText = "spSelect_PersonnelScheduleNotesList '" + StartDate + "', '2' ";
			oRec = ADORecordSetHelper.Open(oCmd, "");
			ViewModel.sprExcept.Col = 1;
			CurrRow += 2;
			ViewModel.sprExcept.Row = CurrRow;
		...
		internal void cmdPrint_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			ViewModel.sprExcept.setPrintAbortMsg("Printing Batt 2 Exception Report - Click Cancel to quit");
		...
		public static frmException2 DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmException2 CreateInstance()
		{
			PTSProject.frmException2 theInstance = Shared.Container.Resolve< frmException2>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmException2ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmException2 m_vb6FormDefInstance { get; set; }
