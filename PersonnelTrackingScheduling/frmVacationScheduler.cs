...
namespace PTSProject
{
	...
	public partial class frmVacationScheduler
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmVacationSchedulerViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmVacationScheduler));
		...
		public void SetMaxLeave(System.DateTime DateCheck)
		{
			...
			if (!oRec.EOF)
			{
				...
				ViewModel.MaxAllowed = Convert.ToInt32(modGlobal.GetVal(oRec["max_leave_allowed"]));
			}
			else
			{
				ViewModel.MaxAllowed = 9;
			}
		...
		public void SetCalendarShifts()
		{
			...
			frmVacationScheduler.DefInstance.ViewModel.Visible = false;
			...
			oCmd.CommandText = "spSelect_AnnualCalendarStep2 '" + modGlobal.Shared.gCurrentYear.ToString() + "' ";
			...
			if (oRec.EOF)
			{
				...
				frmVacationScheduler.DefInstance.ViewModel.Visible = true;
				return;
			}
		...
		internal void frmVacationScheduler_Activated(Object eventSender, System.EventArgs eventArgs)
		{
		...
		//UPGRADE_WARNING: (2065) Form event frmVacationScheduler.Deactivate has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
		[UpgradeHelpers.Events.Handler]
		internal void frmVacationScheduler_Deactivate(Object eventSender, System.EventArgs eventArgs)
		{
			//    RefreshActiveForm
		}
		...
		public static frmVacationScheduler DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmVacationScheduler CreateInstance()
		{
			PTSProject.frmVacationScheduler theInstance = Shared.Container.Resolve< frmVacationScheduler>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmVacationSchedulerViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmVacationScheduler m_vb6FormDefInstance { get; set; }
