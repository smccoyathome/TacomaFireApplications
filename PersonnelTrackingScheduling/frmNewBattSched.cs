...
namespace PTSProject
{
    ...
    public partial class frmNewBattSched
        : UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNewBattSchedViewModel>, UpgradeHelpers.Interfaces.IInitializable
    {

        void UpgradeHelpers.Interfaces.IInitializable.Init()
        {
            this.CallBaseInit(typeof(frmNewBattSched));
        ...
        //*****************************************
        //New Battalion 1 Scheduler Form
                ...
                {
                    {
                            ...
                            async1.Append<DialogResult, MoveEmployeeStruct>((responseValue) =>
                              {
                                  ...
                                  {
                                      return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmNewBattSched.MoveEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
                                  }
                                           ...
                                           if (!oRec.EOF)
                                           {
                                               ...
                                               for (int i = 1; i <= 11; i++)
                                               {
                                                   ...
                                                   if (oRec.EOF)
                                                   {
                                                       ...
                                                       {
                                                           PayUp = 0;
                                                           return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmNewBattSched.MoveEmployeeStruct(
                                                               )
                        ...
                        return this.Return<MoveEmployeeStruct>(() => new PTSProject.frmNewBattSched.MoveEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
                    }
                }
                catch
                {
        ...
        public DeleteScheduleStruct DeleteSchedule(string Empid, string ShiftDate)
        {
            ...
            catch
            {
                if (modGlobal.ErrorControl() == modGlobal.eFATALERROR)
                {
                    return new PTSProject.frmNewBattSched.DeleteScheduleStruct()
                ...
                {
                    {
                        ...
                        if (!oRec.EOF)
                        {
                            ...
                            else
                            {
                                ...
                                return this.Return<ScheduleEmployeeStruct>(() => new PTSProject.frmNewBattSched.ScheduleEmployeeStruct() { returnValue = false, ShiftDate = ShiftDate, Empid = Empid, });
                            }
                        }
                        ...
                        async1.Append<ScheduleEmployeeStruct>(() =>
                           {
                               using (var async2 = this.Async())
                               {
                                   ...
                                   else
                                   {
                                       ...
                                       Step = Convert.ToInt32(Double.Parse(modGlobal.GetStep(Empid)));
                                       //Determine Step for PayUp
                                       var oCmd2 = UpgradeHelpers.DB.AdoFactoryManager.GetFactory().CreateCommand();
                                       oCmd2.Connection = modGlobal.oConn;
                                       oCmd2.CommandType = CommandType.Text;
                                       oCmd2.CommandText = "sp_FindPayRate '" + JobCode + "'," + Step.ToString();
                                       var oRec2 = ADORecordSetHelper.Open(oCmd2, "");
                                       if (!oRec2.EOF)
                                       {
                                           PayRate = Convert.ToDecimal(oRec2["pay_rate"]);
                                           PayRate = (decimal)Math.Round((double)(PayRate + ((decimal)(((double)PayRate) * 0.05d))), 2);
                                           for (int i = 1; i <= 11; i++)
                                           {
                                               oCmd2.CommandText = "sp_FindPayRate '" + modGlobal.Shared.gPayType + "'," + i.ToString();
                                               ...
                                               {
                                                   if (((double)PayRate) <= Convert.ToDouble(oRec2["pay_rate"]))
                                                   {
                                                       Step = i;
                                                       JobCode = modGlobal.Shared.gPayType.Trim();
                                                       PayUp = -1;
                                   ...
                                   async2.Append(() =>
                                       {
                                           ...
                                           if (UpdateFlag != 0)
                                           {
                                               var returningMetodValue375 = //Delete old Schedule record
                                            DeleteSchedule(Empid, ShiftDate);
                                               Empid = returningMetodValue375.Empid;
                                               ShiftDate = returningMetodValue375.ShiftDate;
                                               UpdateFlag = 0;
                                           }
                                           ...
                                           if (modGlobal.Clean(modGlobal.Shared.gLeaveNotes) != "")
                                           {
                                               oCmd2.CommandText = "spInsertPersonnelScheduleNotes '" + Empid + "','" + ShiftDate + "','" + modGlobal.Clean(modGlobal.Shared.gLeaveNotes) + "','" + modGlobal.Shared.gUser + "' ";
                                               oCmd2.CommandType = CommandType.Text;
                                           ...
                                           if (modGlobal.Shared.gFullShift != 0)
                                           {
                                               ...
                                               oCmd2.CommandText = "sp_GetSchedAssign '" + Empid + "','" + ShiftDate + "'";
                                               var oRec2 = ADORecordSetHelper.Open(oCmd2, "");
                                               if (!oRec2.EOF)
                                               {
                                                   if (Convert.ToDouble(oRec2["assignment_id"]) >= 559 && Convert.ToDouble(oRec2["assignment_id"]) < 563 || (Convert.ToDouble(oRec2["assignment_id"]) == 1167) || (Convert.ToDouble(oRec2["assignment_id"]) == 1283) || (Convert.ToDouble(oRec2["assignment_id"]) == 1284))
                                                   {
                                                       UpdateFlag = -1;
                                                   }
                                                   else if (Convert.ToDouble(oRec2["assignment_id"]) >= 575 && Convert.ToDouble(oRec2["assignment_id"]) <= 578)
                                                   {
                                                       UpdateFlag = -1;
                                                   }
                                                   else if (modGlobal.Clean(oRec2["position_code"]) == "T1" || modGlobal.Clean(oRec2["position_code"]) == "T2" || modGlobal.Clean(oRec2["position_code"]) == "T3" || modGlobal.Clean(oRec2["position_code"]) == "T4")
                                                   {
                                                       UpdateFlag = -1;
                                                   }
                                                   else
                                                   ...
                                                   if (UpdateFlag != 0)
                                                   {
                                                       var returningMetodValue405 = DeleteSchedule(Empid, ShiftDate);
                                                       Empid = returningMetodValue405.Empid;
                                                       ShiftDate = returningMetodValue405.ShiftDate;
                                                       oCmdInsert.ExecuteNonQuery(new object[] { ShiftDate, Empid, AssignID, TimeCode, PayUp, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
                                                   }
                                               }
                                               else
                        ...
                        return this.Return<ScheduleEmployeeStruct>(() => new PTSProject.frmNewBattSched.ScheduleEmployeeStruct() { returnValue = true, ShiftDate = ShiftDate, Empid = Empid, });
                    }
                }
                catch
                {
        ...
        public void FillLists()
        {
            ...
            try
            {
                ...
                ViewModel.sprLeave.MaxRows = CurrRow;
                ;
        ...
        public void GetBattSchedule()
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "spSelect_UnitDrillGroupByBatt " + "'1'";
                oRec = ADORecordSetHelper.Open(oCmd, "");
                ...
                oCmd.CommandText = "sp_GetBattSchedule '" + ShiftDate + "','1'";
                oRec = ADORecordSetHelper.Open(oCmd, "");
                ...
                async1.Append(() =>
                    {
                        ...
                        if (modGlobal.Shared.gFullShift != 0)
                        {
                            ...
                            var returningMetodValue652 = DeleteSchedule(Empid, ShiftDate);
                            Empid = returningMetodValue652.Empid;
                            ShiftDate = returningMetodValue652.ShiftDate;
                            //Come Here
                            oCmd.ExecuteNonQuery(new object[] { ShiftDate, Empid, modGlobal.ASGN181DBT, "DDF", 0, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
        ...
        internal void frmNewBattSched_Activated(Object eventSender, System.EventArgs eventArgs)
        {
        ...
        //UPGRADE_WARNING: (2065) Form event frmNewBattSched.Deactivate has a new behavior. More Information: http://www.vbtonet.com/ewis/ewi2065.aspx
        [UpgradeHelpers.Events.Handler]
        internal void frmNewBattSched_Deactivate(Object eventSender, System.EventArgs eventArgs)
        {
            //Call Global Refresh Form subroutine
            //to refresh displayed data on open forms
            ...
            using (var async1 = this.Async(true))
            {
                ...
                if (ViewModel.lbPosam[Index].Text == "")
                {
                    ...
                    if (Source.Name == "pnSelected")
                    {
                        ...
                        async1.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPosition[Index].Text));
                        async1.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(tempNormalized1 =>
                        {
                            var returningMetodValue785 = tempNormalized1;

                            if (returningMetodValue785.returnValue)
                            {
                                ShiftDate = returningMetodValue785.ShiftDate;
                                tempRefParam = returningMetodValue785.Empid;
                    ...
                    else
                    {
                        ...
                        if (AMPM == "AM")
                        {
                            ...
                            async1.Append<MoveEmployeeStruct>(tempNormalized3 =>
                                {
                                    var returningMetodValue799 = tempNormalized3;
                                    if (returningMetodValue799.returnValue)
                                    {
                                        ShiftDate = returningMetodValue799.ShiftDate;
                                        tempRefParam2 = returningMetodValue799.Empid;
            ...
            using (var async1 = this.Async(true))
            {
                ...
                if (ViewModel.lbPospm[Index].Text == "")
                {
                    ...
                    if (Source.Name == "pnSelected")
                    {
                        ...
                        string tempRefParam = Convert.ToString(ViewModel.pnSelected.Tag);
                        async1.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[UnitID].Text, ShiftDate, tempRefParam, ViewModel.lbPositionPM[Index].Text));
                        async1.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(tempNormalized1 =>
                            {
                                var returningMetodValue832 = tempNormalized1;

                                if (returningMetodValue832.returnValue)
                                {
                                    ShiftDate = returningMetodValue832.ShiftDate;
                                    tempRefParam = returningMetodValue832.Empid;
                ...
                async1.Append(() =>
                    {
                        ...
                        var returningMetodValue1172 = DeleteSchedule(Empid, ShiftDate);
                        Empid = returningMetodValue1172.Empid;
                        ShiftDate = returningMetodValue1172.ShiftDate;
                        ...
                        if (modGlobal.Shared.gFullShift != 0)
                        {
                            ...
                            ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                            var returningMetodValue1180 = DeleteSchedule(Empid, ShiftDate);
                            Empid = returningMetodValue1180.Empid;
                            ShiftDate = returningMetodValue1180.ShiftDate;
                            //Checked out... this is okay
                            oCmd.ExecuteNonQuery(new object[] { ShiftDate, Empid, modGlobal.ASGN181DBT, "DDF", 0, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
        ...
        internal void mnuNewBatt3_Click(Object eventSender, System.EventArgs eventArgs)
        {
            ...
            //"New Battalion 3"
            //    gBattSwitchDate = Format$(Now(), "mm/dd/yyyy")
            ViewManager.NavigateToView(
                                    ...
                                    async2.Append(() =>
                                        {
                                            using (var async3 = this.Async())
                                            {
                                                ...
                                                async3.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[Convert
                                                ...
                                                async3.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(tempNormalized7 =>
                                                    {
                                                        var returningMetodValue1340 = tempNormalized7;

                                                        Response = (returningMetodValue1340.returnValue) ? -1 : 0;
                                                        StartDate = returningMetodValue1340.ShiftDate;
                                                        Empid = returningMetodValue1340.Empid;
        ...
        internal void mnuRemove_Click(Object eventSender, System.EventArgs eventArgs)
        {
            using (var async1 = this.Async(true))
            {
                ...
                async1.Append(() =>
                    {
                        string ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                        var returningMetodValue1526 = DeleteSchedule(Empid, ShiftDate);
                        Empid = returningMetodValue1526.Empid;
                        ShiftDate = returningMetodValue1526.ShiftDate;
                        ...
                        if (modGlobal.Shared.gFullShift != 0)
                        {
                            ...
                            ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                            var returningMetodValue1528 = DeleteSchedule(Empid, ShiftDate);
                            Empid = returningMetodValue1528.Empid;
                            ShiftDate = returningMetodValue1528.ShiftDate;
                            ViewModel.SelectedLabel.Text = "";
                            OtherShift.Text = "";
                            UpgradeHelpers.Helpers.ControlHelper.SetTag(ViewModel.SelectedLabel, "");
                            UpgradeHelpers.Helpers.ControlHelper.SetTag(OtherShift, "");
                ...
                async1.Append(() =>
                    {
                        ...
                        string ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                        string Empid = Convert.ToString(UpgradeHelpers.Helpers.ControlHelper.GetTag(ViewModel.SelectedLabel));
                        var returningMetodValue1557 = DeleteSchedule(Empid, ShiftDate);
                        Empid = returningMetodValue1557.Empid;
                        ShiftDate = returningMetodValue1557.ShiftDate;
                        ...
                        if (modGlobal.Shared.gFullShift != 0)
                        {
                            ...
                            ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                            var returningMetodValue1565 = DeleteSchedule(Empid, ShiftDate);
                            Empid = returningMetodValue1565.Empid;
                            ShiftDate = returningMetodValue1565.ShiftDate;
                            oCmd.ExecuteNonQuery(new object[] { ShiftDate, Empid, modGlobal.ASGN181ROV, "REG", 0, JobCode, Step, DateTime.Now, modGlobal.Shared.gUser });
        ...
        internal void mnuTimeCard_Click(Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (~OpenFlag != 0)
            {
                ...
                frmTimeCard1.DefInstance.ViewModel.sprBatt.PrintSheet(null);
                //frmTimeCard1.DefInstance.ViewModel.sprBatt.Action = (FarPoint.ViewModels.FPActionConstants)32;
                ViewManager.DisposeView(frmTimeCard1.DefInstance);
            }
        }
                                            ...
                                            using (var async3 = this.Async())
                                            {
                                                ...
                                                if (modGlobal.Shared.gFullShift != 0)
                                                {
                                                    ...
                                                    async3.Append<PTSProject.modGlobal.ScheduleLeaveStruct>(tempNormalized3 =>
                                                        {
                                                            var returningMetodValue8 = tempNormalized3;

                                                            Response = returningMetodValue8.returnValue;

                                                            Empid = returningMetodValue8.Empid;

                                                            EndDate = returningMetodValue8.LeaveDate;
                                                        });
                                                }
                                                async3.Append(() =>
                                                    {
                                                        using (var async4 = this.Async())
                                                        {
                                                            ...
                                                            UnitID = FindUnit(UpgradeHelpers.Helpers.ControlArrayHelper.GetControlIndex(ViewModel.SelectedLabel)).ToString();
                                                            async4.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(() => ScheduleEmployee(ViewModel.lbUnit[
                                                            ...
                                                            async4.Append<PTSProject.frmNewBattSched.ScheduleEmployeeStruct>(tempNormalized5 =>
                                                                {
                                                                    var returningMetodValue1679 = tempNormalized5;

                                                                    Response = (returningMetodValue1679.returnValue) ? -1 : 0;
                                                                    StartDate = returningMetodValue1679.ShiftDate;
                                                                    modGlobal.Shared.gTradeEmp = returningMetodValue1679.Empid;
                                ...
                                async2.Append(() =>
                                    {
                                        ...
                                        ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                                        var returningMetodValue1736 = DeleteSchedule(Empid, ShiftDate);
                                        Empid = returningMetodValue1736.Empid;
                                        ShiftDate = returningMetodValue1736.ShiftDate;
                                        ...
                                        if (modGlobal.Shared.gFullShift != 0)
                                        {
                                            ...
                                            ShiftDate = ViewModel.calSchedDate.Value.Date.ToString("M/d/yyyy") + " 7:00" + AMPM;
                                            var returningMetodValue1738 = DeleteSchedule(Empid, ShiftDate);
                                            Empid = returningMetodValue1738.Empid;
                                            ShiftDate = returningMetodValue1738.ShiftDate;
                                            Source.Text = "";
                                            OtherShift.Text = "";
                                            UpgradeHelpers.Helpers.ControlHelper.SetTag(Source, "");
                                            UpgradeHelpers.Helpers.ControlHelper.SetTag(OtherShift, "");
        ...
        public static frmNewBattSched DefInstance
        {
            get
            {
                if (Shared.m_vb6FormDefInstance == null)
        ...
        public static frmNewBattSched CreateInstance()
        {
            PTSProject.frmNewBattSched theInstance = Shared.Container.Resolve<frmNewBattSched>();
        ...
        : UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmNewBattSchedViewModel>, UpgradeHelpers.Interfaces.IInitializable
    {
            ...
            Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
        {
            ...
            public virtual frmNewBattSched m_vb6FormDefInstance { get; set; }
