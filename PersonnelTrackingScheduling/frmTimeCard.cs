...
namespace PTSProject
{
	...
	public partial class frmTimeCard1
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmTimeCard1ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmTimeCard1));
		...
		private void frmTimeCard1_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void FillSpread()
		{
			...
			for (int i = 1; i <= 20; i++)
			{
				...
				{
					case 1 :
						oCmd.CommandText = "spReport_GetUnitBATT '" + StartDate + "','" + EndDate + "','BC01'";
						...
						oCmd.CommandText = "spReport_GetUnitLvBATT '" + StartDate + "','" + EndDate + "','BC01'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 2 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E04'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E04'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 3 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E09'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E09'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 4 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E13'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E13'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 5 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E14'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 4;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E14'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 6 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E16'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 17;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E16'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 7 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','E17'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 17;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','E17'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						...
						break;
					case 8 :
						oCmd.CommandText = "spReport_GetUnit '" + StartDate + "','" + EndDate + "','L03'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
						x = 17;
						CurrName = "";
						CurrTime = "";
						...
						oCmd.CommandText = "spReport_GetUnitLv '" + StartDate + "','" + EndDate + "','L03'";
						oRec = ADORecordSetHelper.Open(oCmd, "");
					...
					case 16 :
						//Rovers List 
						oCmd.CommandText = "spReport_GetRovers '1','" + ShiftCode + "'";
					...
					case 17 :
						//Debit List 
						oCmd.CommandText = "spReport_GetDebits '" + StartDate + "','" + EndDate + "','1'";
						orec2 = ADORecordSetHelper.Open(oCmd, "");
						x = 39;
		...
		internal void cmdExcept_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			/*			frmException1.DefInstance.SetBounds(0, 0, 0				, 0, Stubs._System.Windows.Forms.				BoundsSpecified.X | Stubs._System.Windows.Forms.BoundsSpecified.Y)*/
			;
		...
		internal void cmdPrint_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			ViewModel.sprBatt.setPrintAbortMsg("Printing Batt 1 Time Card Worksheet - Click Cancel to quit");
		...
		public static frmTimeCard1 DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmTimeCard1 CreateInstance()
		{
			PTSProject.frmTimeCard1 theInstance = Shared.Container.Resolve< frmTimeCard1>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmTimeCard1ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmTimeCard1 m_vb6FormDefInstance { get; set; }
