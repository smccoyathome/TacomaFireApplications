...
namespace PTSProject
{
	...
	public partial class frmException3
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmException3ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmException3));
		...
		private void frmException3_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		//**************************************
		//* Batt 3 Time Card Exception Report  *
		//**************************************
		//ADODB
		...
		public void FillSpread()
		{
			...
			oCmd.CommandText = "spSelect_PersonnelScheduleNotesList '" + StartDate + "', '3' ";
			oRec = ADORecordSetHelper.Open(oCmd, "");
			ViewModel.sprExcept.Col = 1;
			CurrRow += 2;
			ViewModel.sprExcept.Row = CurrRow;
		...
		internal void cmdPrint_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			ViewModel.sprExcept.setPrintAbortMsg("Printing Batt 3 Exception Report - Click Cancel to quit");
		...
		private void Form_Load()
		{
			...
			for (int i = 0; i <= ViewManager.OpenFormsCount - 1; i++)
			{
				...
				{
					ViewModel.calDate.Value = frmTimeCard3.DefInstance.ViewModel.calDate.Value.Date;
					return;
					//        Else
		...
		public static frmException3 DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null)
		...
		public static frmException3 CreateInstance()
		{
			PTSProject.frmException3 theInstance = Shared.Container.Resolve< frmException3>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmException3ViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmException3 m_vb6FormDefInstance { get; set; }
