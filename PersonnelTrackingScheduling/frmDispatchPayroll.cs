...
namespace PTSProject
{
	...
	public partial class frmDispatchPayroll
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmDispatchPayrollViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{

		void UpgradeHelpers.Interfaces.IInitializable.Init()
		{
			this.CallBaseInit(typeof(frmDispatchPayroll));
		...
		private void frmDispatchPayroll_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void RefreshEmployeeList()
		{
			...
			oCmd.Connection = modGlobal.oConn;
			oCmd.CommandType = CommandType.Text;
			sStringText = "spSelect_DispatchEmployeeGridList ";
		...
		internal void cmdApply1_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			//    If NeedFillerCode Then
			//        'continue... no need to check
			//    ElseIf PayrollCL.GetTimeCodeByKOT(RTrim(Right$(cboAAType1.Text, 3))) Then
			//        If PayrollCL.TCfillercode <> "" Then
			//            NeedFillerCode = True
			//            CurrFillerCode = PayrollCL.TCfillercode
			//        End If
			//    End If
			ViewModel.NeedFillerCode = false;
			ViewModel.CurrFillerCode = "";
		...
		internal void cmdApply2_Click(Object eventSender, System.EventArgs eventArgs)
		{
			...
			//    If NeedFillerCode Then
			//        'continue... no need to check
			//    ElseIf PayrollCL.GetTimeCodeByKOT(RTrim(Right$(cboAAType2.Text, 3))) Then
			//        If PayrollCL.TCfillercode <> "" Then
			//            NeedFillerCode = True
			//            CurrFillerCode = PayrollCL.TCfillercode
			//        End If
		...
		private void Form_Load()
		{
			...
			{
				modGlobal.Shared.gMaxhoursOp = 80;
			}
			else
			{
				modGlobal.Shared.gMaxhoursOp = 80;
		...
		private void sprEmployeeList_CellClick(object eventSender, Stubs._FarPoint.Win.Spread.CellClickEventArgs eventArgs)
		{
			...
			FillTimeCard();
			FormatTimeCard();
			ViewModel.cmdPrint.Enabled = ViewModel.OKToPay;
		...
		public static frmDispatchPayroll DefInstance
		{
			get
			{
				if ( Shared.m_vb6FormDefInstance == null )
		...
		public static frmDispatchPayroll CreateInstance()
		{
			PTSProject.frmDispatchPayroll theInstance = Shared.Container.Resolve<frmDispatchPayroll>();
		...
		: UpgradeHelpers.Helpers.FormBase<PTSProject.ViewModels.frmDispatchPayrollViewModel>, UpgradeHelpers.Interfaces.IInitializable
	{
			...
			Interfaces.IInteractsWithView, UpgradeHelpers.Interfaces.IInitializableCommon, UpgradeHelpers.Interfaces.IInitializable
		{
			...
			public virtual frmDispatchPayroll m_vb6FormDefInstance { get; set; }
